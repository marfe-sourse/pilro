...
ControllerAll = false
local ListSudos ={Sudo_Id,5359109940,1983379011}  
...
if tonumber(msg.sender.user_id) == 5359109940 then
...
if text and Redis:get(Thepirlo..'lock:Fshar'..msg.chat_id) and not msg.Special then 
list = {"كس","كسمك","كسختك","عير","كسخالتك","خرا بالله","عير بالله","كسخواتكم","كحاب","مناويج","مناويج","كحبه","ابن الكحبه","فرخ","فروخ","طيزك","طيزختك","مناويج"}
...
if text and Redis:get(Thepirlo..'lock:Fars'..msg.chat_id) and not msg.Special then 
...
local N = (Redis:get(Thepirlo.."Name:Bot") or "دراكون")
...
--download('https://raw.githubusercontent.com/https:/marfe-sourse/pilro/master/pilro','pilro.lua')
...
NamesBot = (Redis:get(Thepirlo.."pirlo:Name:Bot") or "دراكون")
...
{
{text = Jabwa, url = 'https://t.me/Dragonmohsbot'}, 
},
{
{text = Grosupsw, url = 'https://t.me/Dragonmohsbot'}, 
},
{
{text = Usperos, url = 'https://t.me/Dragonmohsbot'}, 
},
}
...
Redis:sadd(Thepirlo.."pirlo:TheBasics:Group"..msg_chat_id,msg.sender.user_id) 
...
{
{text = ' ❲ S𝘰𝘶𝘳𝘤𝘦 𝔇ℜ𝔞𝔤𝔬𝔫 ❳ ',url="https://t.me/c_p_8"}
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id,'\n*᥀︙ اهلا بك مجددا عزيزي \n᥀︙ اليك الازرار الخاصه بأوامر التسليه الخاصه بسوࢪس دࢪاكون فقط اضغط على الامر الذي تريد تنفيذه *','md', true, false, false, false, reply_markup)
end
...
if Manager(msg) then
if text == "الصلاحيات" and ChCheck(msg) or text == "فحص البوت" and ChCheck(msg) then
...
Dev_pilro(msg.chat_id_, msg.id_, 1, '᥀︙صلاحيات البوت هي ↫ ⤈\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n᥀︙حذف الرسائل ↫ '..DEL..'\n᥀︙دعوة المستخدمين ↫ '..INV..'\n᥀︙حظر المستخدمين ↫ '..BAN..'\n᥀︙تثبيت الرسائل ↫ '..PIN..'\n᥀︙تغيير المعلومات ↫ '..EDT..'\n᥀︙اضافة مشرفين ↫ '..VIP..'\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉', 1, 'md')
end
...
if Redis:get(Thepirlo.."zhrfa"..msg.sender.user_id) == "sendzh" then
...
local UserId_Info = LuaTele.searchPublicChat("K_8_U")
if UserId_Info.id then
local UserInfo = LuaTele.getUser(UserId_Info.id)
local InfoUser = LuaTele.getUserFullInfo(UserId_Info.id)
if InfoUser.bio then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '᥀︙ رابط الحذف',url="https://my.telegram.org/auth?to=delete"},{text = '᥀︙ بوت الحذف ',url="https://t.me/LC6BOT"}},
{{text = ' ᥀︙ رابط حذف الانستكرام',url="https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/"},{text = 'Delete pirlochat',url="https://accounts.pirlochat.com/accounts/login?continue=https%3A%2F%2Faccounts.pirlochat.com%2Faccounts%2Fdeleteaccount"}},{{text= '❲ 𝔇ℜ𝔞𝔤𝔬𝔫  𝖲𝗈𝗎𝗋𝖼𝖾 ❳',url="t.me/c_p_8"}}
}
local msg_id = msg.id/2097152/0.5
...
if text == "زواج" or text == "زوجني" or text == "رفع زوجتي" or text == "رفع زوجي" and msg.reply_to_message_id ~= 0 then
  local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
  local UserInfo = LuaTele.getUser(Message_Reply.sender.user_id)
  ...
  if Redis:sismember(Thepirlo..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
    local rd_mtzwga = {
    ...
    return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_mtzwga[math.random(#rd_mtzwga)]).Reply,"md",true)  
      ...
      local rd_zwag = {
        ...
        "تم زواجكم عمري خاف العريس ميدبرها راسلو دراكون يدبرها 😹🏃‍♀️.",
        "كلللللويششش الف الصلاه والسلام عليك ياحبيب الله محمد 🙈😻."
      }
    if Redis:sismember(Thepirlo..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) then 
    Redis:srem(Thepirlo..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id)
    end
    Redis:sadd(Thepirlo..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) 
...
if text == "تاك للزوجات" or text == "الزوجات" then
  local zwgat_list = Redis:smembers(Thepirlo..msg_chat_id.."zwgat:")
...
if text == "طلاق" or text == "تنزيل زوجتي" or text == "تزيل زوجي" and msg.reply_to_message_id ~= 0 then
  ...
  if Redis:sismember(Thepirlo..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
    Redis:srem(Thepirlo..msg_chat_id.."zwgat:",Message_Reply.sender.user_id)
    Redis:sadd(Thepirlo..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) 
    local rd_tmtlaq = {
      "تم طلاقكم للاسف",
      "تم الطلاق بسبب سحر ام عباس 🙂💔.",
      "تم الطلاق بسبب الاخ ميعرف شي 😹🏃‍♀️.",
      "تم الطلاق بسبب شيماء تدخلت بيناتهم ",
      "تم الطلاق راسلو دراكون يرجعكم 😹🏃‍♀️."
    }
...
local Text =[[
*᥀︙ 𝗐ᴇʟᴄᴏ𝗆𝖾 ᴛᴏ 𝗌𝗈𝗎𝗋𝖼𝖾 𝔇ℜ𝔞𝔤𝔬𝔫 .*
⋆┄┄─┄─┄─┄┄─┄─┄┄⋆
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ' ❲ S𝘰𝘶𝘳𝘤𝘦 𝔇ℜ𝔞𝔤𝔬𝔫 ❳ ',url="https://t.me/c_p_8"},{text = '  ❲ 𝘦𝘹𝘱𝘭𝘢𝘯𝘢𝘵𝘪𝘰𝘯𝘴 ❳ ',url="https://t.me/c_p_8"}
},
{
{text = '❲ 𝖼𝗈𝖽𝖾𝗋 ❳',url="https://t.me/s_l_3"}
},
...
{
{text = '❲ VIP version updates ❳', url = "https://https://t.me/c_p_8"}
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = Redis:get(Thepirlo.."pirlo:Group:Link"..msg_chat_id) 
if GetLink then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
...
if text == (Redis:get(Thepirlo.."pirlo:Name:Bot") or "دراكون") then
local NamesBot = (Redis:get(Thepirlo.."pirlo:Name:Bot") or "دراكون")
local NameBots = {
"يروح "..NamesBot.. " كول؟",
"انا "..NamesBot.. " القميل",
"هاعمري",
...
if text == (Redis:get(Thepirlo.."pirlo:Name:Bot") or "آيلاند") then
local photo = LuaTele.getUserProfilePhotos(Thepirlo)
local UserInfo = LuaTele.getUser(Thepirlo)
for Name_User in string.gmatch(UserInfo.first_name, "[^%s]+" ) do
UserInfo.first_name = Name_User
...
local NamesBot = (Redis:get(Thepirlo.."pirlo:Name:Bot") or "آيلاند")
local BotName = {
"يروح "..NamesBot.. " كول؟",
"انا "..NamesBot.. " القميل",
"هاعمري",
...
{
{text = '᥀︙ سۅࢪس دراكون -', url = 't.me/c_p_8'},
},
}
}
...
if tonumber(IdUser) == tonumber(UserId) then
Abs = math.random(2,54); 
local Text ='* 𝔇ℜ𝔞𝔤𝔬𝔫 𝖲𝗈𝗎𝗋𝖼𝖾 \n⋆┄┄─┄─┄─┄┄─┄─┄┄⋆*'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '❲ S𝘰𝘶𝘳𝘤𝘦 𝔇ℜ𝔞𝔤𝔬𝔫 ❳',url="https://t.me/c_p_8"},{text = ' Updates source ⁦ᯓ',url="https://t.me/c_p_8"}
},
{
{text = '  𝔇ℜ𝔞𝔤𝔬𝔫 ⁦ᯓ',url="https://t.me/s_l_3"}
},
}
local msg_id = Msg_id/2097152/0.5
...
{
{text = '❲ ‹ ︙𝔇ℜ𝔞𝔤𝔬𝔫 𝖲𝗈𝗎𝗋𝖼𝖾 ❳',url="t.me/c_p_8"}
},
}
local msg_id = Msg_id/2097152/0.5
...
{
{text = '❲ 𝔇ℜ𝔞𝔤𝔬𝔫 𝖲𝗈𝗋𝖼𝖾 ❳',url="t.me/c_p_8"}
},
}
...
local TextHelp = [[*
᥀︙ أهلا بك في قائمة العاب سوࢪس دࢪاكون اختر نوع الالعاب 
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
local TextHelp = [[*
᥀︙ مرحبا بك في الالعاب المتطورة الخاص بسوࢪس دࢪاكون 
