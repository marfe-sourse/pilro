...
local N = (Redis:get(Thepirlo.."Name:Bot") or "علوش")
...
NamesBot = (Redis:get(Thepirlo.."pirlo:Name:Bot") or "علوش")
...
{
{text = ' ❲ ‹ 𝘚𝘰𝘶𝘳𝘤𝘦   ‹ ︙𝔇ℜ𝔞𝔤𝔬𝔫 𝔱𝔢𝔞𝔪 .. ❳ ',url="https://t.me/c_p_8"}
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id,'\n*‹ : اهلا بك مجددا عزيزي \n‹ : اليك الازرار الخاصه بأوامر التسليه الخاصه بسورس  𝘚𝘰𝘶𝘳𝘤𝘦   ‹ ︙𝔇ℜ𝔞𝔤𝔬𝔫 𝔱𝔢𝔞𝔪 .فقط اضغط على الامر الذي تريد تنفيذه *','md', true, false, false, false, reply_markup)
end
...
photo = "https://t.me/allush7/7"
local Text =[[
*‹ : 𝗐ᴇʟᴄᴏ𝗆𝖾 ᴛᴏ 𝗌𝗈𝗎𝗋𝖼𝖾 ‹ 𝘚𝘰𝘶𝘳𝘤𝘦   ‹ ︙𝔇ℜ𝔞𝔤𝔬𝔫 𝔱𝔢𝔞𝔪 .
⋆┄┄─┄─┄─┄┄─┄─┄┄⋆
*
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝗎𝗉𝖽𝖺𝗍𝖾𝗌', url = 'https://t.me/c_p_8'},{text = '. ‹ 𝘚𝘰𝘶𝘳𝘤𝘦   ‹ ︙𝔇ℜ𝔞𝔤𝔬𝔫 𝔱𝔢𝔞𝔪 .', url = 'https://t.me/c_p_8'}, 
},
{
...
LuaTele.sendText(msg_chat_id,msg_id,"‹ : انت علش مطور السورس يقلبي🌚💘","md",true)
...
if ChannelJoin(msg) == false then
local Get_Chat = LuaTele.getChat(Redis:get(Thepirlo..'pirlo:ChanneliD:Join'))
local NcH = (Redis:get(Thepirlo.."pirlo:CH:Bot") or Get_Chat.title)
local NcHlink = (Redis:get(Thepirlo.."pirlo:CHlink:Bot") or "‹ : عذراً لاتستطيع استخدام البوت !\n‹ : عليك الاشتراك في القناة اولاً :")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(Thepirlo..'pirlo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(Thepirlo.."pirlo:Lock:Taf"..msg_chat_id,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(Thepirlo..'pirlo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
Redis:del(Thepirlo.."pirlo:Lock:Taf"..msg_chat_id)  
...
if text == (Redis:get(Thepirlo.."pirlo:Name:Bot") or "علوش") then
local NamesBot = (Redis:get(Thepirlo.."pirlo:Name:Bot") or "علوش")
local NameBots = {
"يروح "..NamesBot.. " كول؟",
"انا "..NamesBot.. " القميل",
"هاعمري",
...
"اختفوووو يلعار ابلع من عمك علش??🏃‍♀️.",
...
redis:setex(bot_id.."pirlo" .. msg.chat_id .. ":" .. msg.sender.user_id,60, true)
...
if redis:get(bot_id.."pirlo" .. msg.chat_id .. ":" .. msg.sender.user_id) then
if text == "بنك دراكون" then
local ban = bot.getUser(msg.sender.user_id)
if ban.first_name then
news = ""..ban.first_name..""
else
...
redis:del(bot_id.."pirlo" .. msg.chat_id .. ":" .. msg.sender.user_id) 
bot.sendText(msg.chat_id,msg.id, "\n• وسوينا لك حساب في البنك ( بنك دراكون 💳 )  \n\n• رقم حسابك ↢ ( `"..creditcc.."` )\n• نوع البطاقة ↢ ( "..gg.." )\n• فلوسك ↢ ( `"..flossst.."` $ 💸 )  ","md",true)  
end 
...
redis:sadd(bot_id.."noooybgy",msg.sender.user_id)
redis:del(bot_id.."pirlo" .. msg.chat_id .. ":" .. msg.sender.user_id) 
bot.sendText(msg.chat_id,msg.id, "\n• وسوينا لك حساب في البنك ( بنك الدولي 💳 ) \n\n• رقم حسابك ↢ ( `"..creditvi.."` )\n• نوع البطاقة ↢ ( "..gg.." )\n• فلوسك ↢ ( `"..flossst.."` $ 💸 )  ","md",true)   
end 
...
if text == 'كنز' then
ballanceed = redis:get(bot_id.."pirlo"..msg.sender_id.user_id) or 0
...
local ballancee = redis:get(bot_id.."pirlo"..msg.sender_id.user_id) or 0
shkse = redis:get(bot_id.."shkse"..msg.sender_id.user_id)
if shkse == "طيبة" then
if Descriptioont == "1" then
local knez = ballancee + 40000
redis:set(bot_id.."pirlo"..msg.sender_id.user_id , knez)
local ballancee = redis:get(bot_id.."pirlo"..msg.sender_id.user_id) or 0
...
keyboard.inline_keyboard = {
{
{text = '❲ ‹ 𝘚𝘰𝘶𝘳𝘤𝘦   ‹ ︙𝔇ℜ𝔞𝔤𝔬𝔫 𝔱𝔢𝔞𝔪 .. ❳',url="https://t.me/c_p_8"},{text = ' Updates source ⁦ᯓ',url="https://t.me/c_p_8"}
},
{
...
{
{text = '❲ ‹ 𝘚𝘰𝘶𝘳𝘤𝘦   ‹ ︙𝔇ℜ𝔞𝔤𝔬𝔫 𝔱𝔢𝔞𝔪 . ❳',url="t.me/c_p_8"}
},
}
local msg_id = Msg_id/2097152/0.5
...
همسه مثال | @Dragonmohsbot هلا💘 @@s_l_3
...
local TextHelp = [[*
‹ : أهلا بك في قائمة العاب سورس  دراكوناختر نوع الالعاب 
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
local TextHelp = [[*
‹ : مرحبا بك في الالعاب المتطورة الخاص بسورس  دراكون
