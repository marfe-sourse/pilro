...
local Thepirlo = io.open("Thepirlo", 'w')
Thepirlo:write([[
cd $(cd $(dirname $0); pwd)
while(true) do
...
cd $(cd $(dirname $0); pwd)
while(true) do
screen -S Thepirlo -X kill
screen -S Thepirlo ./Thepirlo
done
]])
Run:close()
...
os.execute('chmod +x Thepirlo;chmod +x Run;./Run')
end
...
Thepirlo = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..Thepirlo)
LuaTele = luatele.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=Thepirlo,token=Token}
function var(value)  
...
ControllerAll = false
local ListSudos ={Sudo_Id,1983379011}  
...
Status = 0
DevelopersQ = Redis:sismember(Thepirlo.."pirlo:DevelopersQ:Groups",UserId) 
if UserId == 1983379011 then
Status = true
elseif UserId == 1983379011 then
Status = true
elseif UserId == Sudo_Id then  
Status = true
elseif UserId == Thepirlo then
Status = true
...
Status = 0
Developers = Redis:sismember(Thepirlo.."pirlo:Developers:Groups",UserId) 
DevelopersQ = Redis:sismember(Thepirlo.."pirlo:DevelopersQ:Groups",UserId) 
TheBasicsQ = Redis:sismember(Thepirlo.."pirlo:TheBasicsQ:Group"..ChatId,UserId) 
TheBasics = Redis:sismember(Thepirlo.."pirlo:TheBasics:Group"..ChatId,UserId) 
Originators = Redis:sismember(Thepirlo.."pirlo:Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(Thepirlo.."pirlo:Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(Thepirlo.."pirlo:Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(Thepirlo.."pirlo:Distinguished:Group"..ChatId,UserId)
...
Status = 'المطور'
elseif DevelopersQ then
Status = Redis:get(Thepirlo.."pirlo:Developer:Bot:Reply"..ChatId) or 'المطور الثانوي'
elseif TheBasicsQ then
Status = "المالك"
elseif TheBasics then
Status = Redis:get(Thepirlo.."pirlo:President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(Thepirlo.."pirlo:Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(Thepirlo.."pirlo:Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(Thepirlo.."pirlo:Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك الكروب'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن المجموعه'
elseif Distinguished then
Status = Redis:get(Thepirlo.."pirlo:Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(Thepirlo.."pirlo:Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(Thepirlo.."pirlo:lockpin"..ChatId) then    
lock_pin = "✔️"
else 
lock_pin = "❌"    
end
if Redis:get(Thepirlo.."pirlo:Lock:tagservr"..ChatId) then    
lock_tagservr = "✔️"
else 
lock_tagservr = "❌"
end
if Redis:get(Thepirlo.."pirlo:Lock:text"..ChatId) then    
lock_text = "✔️"
else 
lock_text = "❌ "    
end
if Redis:get(Thepirlo.."pirlo:Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✔️"
else 
lock_add = "❌ "    
end    
if Redis:get(Thepirlo.."pirlo:Lock:Join"..ChatId) == "kick" then
lock_join = "✔️"
else 
lock_join = "❌ "    
end    
if Redis:get(Thepirlo.."pirlo:Lock:edit"..ChatId) then    
lock_edit = "✔️"
else 
lock_edit = "❌ "    
end
if Redis:get(Thepirlo.."pirlo:Chek:Welcome"..ChatId) then
welcome = "✔️"
else 
welcome = "❌ "    
end
if Redis:hget(Thepirlo.."pirlo:Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(Thepirlo.."pirlo:Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(Thepirlo.."pirlo:Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(Thepirlo.."pirlo:Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✔️"
else     
flood = "❌ "     
end
if Redis:get(Thepirlo.."pirlo:Lock:Photo"..ChatId) == "del" then
lock_photo = "✔️" 
elseif Redis:get(Thepirlo.."pirlo:Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(Thepirlo.."pirlo:Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(Thepirlo.."pirlo:Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "❌ "   
end    
if Redis:get(Thepirlo.."pirlo:Lock:Contact"..ChatId) == "del" then
lock_phon = "✔️" 
elseif Redis:get(Thepirlo.."pirlo:Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(Thepirlo.."pirlo:Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(Thepirlo.."pirlo:Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "❌ "    
end    
if Redis:get(Thepirlo.."pirlo:Lock:Link"..ChatId) == "del" then
lock_links = "✔️"
elseif Redis:get(Thepirlo.."pirlo:Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(Thepirlo.."pirlo:Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(Thepirlo.."pirlo:Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "❌ "    
end
if Redis:get(Thepirlo.."pirlo:Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✔️"
elseif Redis:get(Thepirlo.."pirlo:Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(Thepirlo.."pirlo:Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(Thepirlo.."pirlo:Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "❌ "    
end
if Redis:get(Thepirlo.."pirlo:Lock:User:Name"..ChatId) == "del" then
lock_user = "✔️"
elseif Redis:get(Thepirlo.."pirlo:Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(Thepirlo.."pirlo:Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(Thepirlo.."pirlo:Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "❌ "    
end
if Redis:get(Thepirlo.."pirlo:Lock:hashtak"..ChatId) == "del" then
lock_hash = "✔️"
elseif Redis:get(Thepirlo.."pirlo:Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(Thepirlo.."pirlo:Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(Thepirlo.."pirlo:Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "❌ "    
end
if Redis:get(Thepirlo.."pirlo:Lock:vico"..ChatId) == "del" then
lock_muse = "✔️"
elseif Redis:get(Thepirlo.."pirlo:Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(Thepirlo.."pirlo:Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(Thepirlo.."pirlo:Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "❌ "    
end 
if Redis:get(Thepirlo.."pirlo:Lock:Video"..ChatId) == "del" then
lock_ved = "✔️"
elseif Redis:get(Thepirlo.."pirlo:Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(Thepirlo.."pirlo:Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(Thepirlo.."pirlo:Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "❌ "    
end
if Redis:get(Thepirlo.."pirlo:Lock:Animation"..ChatId) == "del" then
lock_gif = "✔️"
elseif Redis:get(Thepirlo.."pirlo:Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(Thepirlo.."pirlo:Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(Thepirlo.."pirlo:Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "❌ "    
end
if Redis:get(Thepirlo.."pirlo:Lock:Sticker"..ChatId) == "del" then
lock_ste = "✔️"
elseif Redis:get(Thepirlo.."pirlo:Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(Thepirlo.."pirlo:Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(Thepirlo.."pirlo:Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "❌ "    
end
if Redis:get(Thepirlo.."pirlo:Lock:geam"..ChatId) == "del" then
lock_geam = "✔️"
elseif Redis:get(Thepirlo.."pirlo:Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(Thepirlo.."pirlo:Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(Thepirlo.."pirlo:Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "❌ "    
end    
...
if Redis:get(Thepirlo.."pirlo:Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✔️"
elseif Redis:get(Thepirlo.."pirlo:Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(Thepirlo.."pirlo:Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(Thepirlo.."pirlo:Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "❌ "
end
if Redis:get(Thepirlo.."pirlo:Lock:forward"..ChatId) == "del" then
lock_fwd = "✔️"
elseif Redis:get(Thepirlo.."pirlo:Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(Thepirlo.."pirlo:Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(Thepirlo.."pirlo:Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "❌ "    
end    
if Redis:get(Thepirlo.."pirlo:Lock:Document"..ChatId) == "del" then
lock_file = "✔️"
elseif Redis:get(Thepirlo.."pirlo:Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(Thepirlo.."pirlo:Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(Thepirlo.."pirlo:Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "❌ "    
end    
if Redis:get(Thepirlo.."pirlo:Lock:Unsupported"..ChatId) == "del" then
lock_self = "✔️"
elseif Redis:get(Thepirlo.."pirlo:Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(Thepirlo.."pirlo:Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(Thepirlo.."pirlo:Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "❌ "    
end
if Redis:get(Thepirlo.."pirlo:Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✔️"
elseif Redis:get(Thepirlo.."pirlo:Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(Thepirlo.."pirlo:Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "❌ "    
end
if Redis:get(Thepirlo.."pirlo:Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✔️"
elseif Redis:get(Thepirlo.."pirlo:Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(Thepirlo.."pirlo:Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(Thepirlo.."pirlo:Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "❌ "    
end
if Redis:get(Thepirlo.."pirlo:Lock:Spam"..ChatId) == "del" then    
lock_spam = "✔️"
elseif Redis:get(Thepirlo.."pirlo:Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(Thepirlo.."pirlo:Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(Thepirlo.."pirlo:Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "❌ "    
end        
...
return{
BanAll = Redis:sismember(Thepirlo.."pirlo:BanAll:Groups",UserId) ,
BanGroup = Redis:sismember(Thepirlo.."pirlo:BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(Thepirlo.."pirlo:SilentGroup:Group"..ChatId,UserId)
}
end
...
return {
Lock     = '[  ‹ ︙𝔇ℜ𝔞𝔤𝔬𝔫 𝔱𝔢𝔞𝔪 . ](https://t.me/c_p_8)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n‹ : بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n‹ : خاصيه المسح *',
unLock   = '[  ‹ ︙𝔇ℜ𝔞𝔤𝔬𝔫 𝔱𝔢𝔞𝔪 . ](https://t.me/c_p_8)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n‹ : بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[  ‹ ︙𝔇ℜ𝔞𝔤𝔬𝔫 𝔱𝔢𝔞𝔪 . ](https://t.me/c_p_8)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n‹ : بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n‹ : خاصيه الكتم *',
lockKid  = '[  ‹ ︙𝔇ℜ𝔞𝔤𝔬𝔫 𝔱𝔢𝔞𝔪 . ](https://t.me/c_p_8)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n‹ : بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n‹ : خاصيه التقييد *',
lockKick = '[  ‹ ︙𝔇ℜ𝔞𝔤𝔬𝔫 𝔱𝔢𝔞𝔪 . ](https://t.me/c_p_8)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n‹ : بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n‹ : خاصيه الطرد *',
Reply    = '[  ‹ ︙𝔇ℜ𝔞𝔤𝔬𝔫 𝔱𝔢𝔞𝔪 . ](https://t.me/c_p_8)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n🔰 : المستخدم⇷ *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,Thepirlo).status
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local Channel = Redis:get(Thepirlo..'pirlo:Channel:Join')
if Channel then
...
local msg_id = msg.id
var(msg.content)
if data.sender.luatele == "messageSenderChat" and Redis:get(Thepirlo.."Lock:channell"..msg_chat_id) then
print(Redis:get(Thepirlo.."chadmin"..msg_chat_id))
print(data.sender.chat_id)
if data.sender.chat_id ~= Redis:get(Thepirlo.."chadmin"..msg_chat_id) then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
Redis:incr(Thepirlo..'pirlo:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
...
if tonumber(msg.sender.user_id) == tonumber(Thepirlo) then
...
if tonumber(msg.sender.user_id) == 1983379011 then
msg.Name_Controller = 'مطوࢪ السوࢪس  '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 1983379011 then
msg.Name_Controller = 'مبࢪمج السورس '
msg.The_Controller = 1
elseif The_ControllerAll(msg.sender.user_id) == true then  
msg.The_Controller = 1
msg.Name_Controller = 'المطور الاساسي '
elseif Redis:sismember(Thepirlo.."pirlo:DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(Thepirlo.."pirlo:Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(Thepirlo.."pirlo:Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(Thepirlo.."pirlo:TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = "المالك"
elseif Redis:sismember(Thepirlo.."pirlo:TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(Thepirlo.."pirlo:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(Thepirlo.."pirlo:Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(Thepirlo.."pirlo:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(Thepirlo.."pirlo:Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(Thepirlo.."pirlo:Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(Thepirlo.."pirlo:Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(Thepirlo.."pirlo:Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(Thepirlo.."pirlo:Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(Thepirlo.."pirlo:Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(Thepirlo) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(Thepirlo.."pirlo:Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(Thepirlo.."pirlo:Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(Thepirlo.."pirlo:Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(Thepirlo.."pirlo:Welcome:Group"..msg_chat_id)
if Welcome then 
if UserInfo.username then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(Thepirlo.."pirlo:Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(Thepirlo) then
return false
end
local floods = Redis:hget(Thepirlo.."pirlo:Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(Thepirlo.."pirlo:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(Thepirlo.."pirlo:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(Thepirlo.."pirlo:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(Thepirlo.."pirlo:Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(Thepirlo.."pirlo:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
Redis:setex(Thepirlo.."pirlo:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(Thepirlo.."pirlo:Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(Thepirlo.."pirlo:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
if text and Redis:get(Thepirlo..'lock:Fars'..msg.chat_id) and not msg.Distinguished then 
...
sens = 400  
if Redis:get(Thepirlo.."pirlo:Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Thepirlo.."pirlo:Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Thepirlo.."pirlo:Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Thepirlo.."pirlo:Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(Thepirlo.."pirlo:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Originators then -- التوجيه
local Fwd_Group = Redis:get(Thepirlo.."pirlo:Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(Thepirlo.."pirlo:Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(Thepirlo.."pirlo:Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(Thepirlo.."pirlo:Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(Thepirlo.."pirlo:lockpin"..msg_chat_id)
...
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(Thepirlo.."pirlo:Lock:Join"..msg.chat_id) == "kick" then
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end
...
Redis:incr(Thepirlo.."Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(Thepirlo.."Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(Thepirlo.."Lock:Bot:kick"..msg_chat_id)
for k,v in pairs(msg.content.member_user_ids) do
local Info_User = LuaTele.getUser(v) 
print(v)
if v == tonumber(Thepirlo) then
local N = (Redis:get(Thepirlo.."Name:Bot") or "الروكس")
photo = LuaTele.getUserProfilePhotos(Thepirlo)
...
Redis:set(Thepirlo.."Who:Added:Me"..msg_chat_id..":"..v,msg.sender.user_id)
...
Redis:incr(Thepirlo.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
Redis:set(Thepirlo..':toob:Name:'..msg.sender.user_id,NameLUser)
end
end
if msg.content.luatele == "messageContact" and not msg.Distinguished then  -- الجهات
local Contact_Group = Redis:get(Thepirlo.."pirlo:Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(Thepirlo.."pirlo:Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(Thepirlo.."pirlo:Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(Thepirlo.."pirlo:Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(Thepirlo.."pirlo:Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(Thepirlo.."pirlo:Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(Thepirlo.."pirlo:Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(Thepirlo.."pirlo:Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(Thepirlo.."pirlo:Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(Thepirlo.."pirlo:Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(Thepirlo.."pirlo:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
local ChatPhoto = LuaTele.setChatPhoto(msg_chat_id,msg.content.photo.sizes[2].photo.remote.id)
if (ChatPhoto.luatele == "error") then
Redis:del(Thepirlo.."pirlo:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(Thepirlo.."pirlo:Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(Thepirlo.."pirlo:Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(Thepirlo.."pirlo:Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(Thepirlo.."pirlo:Lock:Cmd"..msg_chat_id)
...
if (Redis:get(Thepirlo..'pirlo:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(Thepirlo.."pirlo:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(Thepirlo.."pirlo:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(Thepirlo.."pirlo:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(Thepirlo.."pirlo:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(Thepirlo.."pirlo:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(Thepirlo.."pirlo:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(Thepirlo.."pirlo:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(Thepirlo.."pirlo:List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(Thepirlo..'pirlo:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(Thepirlo..'pirlo:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(Thepirlo.."pirlo:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(Thepirlo.."pirlo:Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(Thepirlo.."pirlo:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(Thepirlo..'pirlo:FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(Thepirlo..'pirlo:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(Thepirlo.."pirlo:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(Thepirlo.."pirlo:Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(Thepirlo.."pirlo:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(Thepirlo.."pirlo:Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(Thepirlo.."pirlo:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(Thepirlo.."pirlo:Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(Thepirlo.."pirlo:List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(Thepirlo.."pirlo:Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(Thepirlo..'pirlo:FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(Thepirlo.."pirlo:Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(Thepirlo.."pirlo:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(Thepirlo.."pirlo:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(Thepirlo.."pirlo:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(Thepirlo.."pirlo:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(Thepirlo.."pirlo:Command:List:Group"..msg_chat_id,text)
...
Redis:del(Thepirlo.."pirlo:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(Thepirlo.."pirlo:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(Thepirlo.."pirlo:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(Thepirlo.."pirlo:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(Thepirlo.."pirlo:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(Thepirlo.."pirlo:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(Thepirlo.."pirlo:Command:Reids:Group:New"..msg_chat_id)
Redis:set(Thepirlo.."pirlo:Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(Thepirlo.."pirlo:Command:List:Group"..msg_chat_id,text)
Redis:del(Thepirlo.."pirlo:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم حفظ الامر باسم ← { "..text..' }',"md",true)
end
if Redis:get(Thepirlo.."pirlo:Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(Thepirlo.."pirlo:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(Thepirlo.."pirlo:Group:Link"..msg_chat_id,LinkGroup)
Redis:del(Thepirlo.."pirlo:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"📥︙تم حفظ الرابط بنجاح","md",true)         
end
end 
if Redis:get(Thepirlo.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(Thepirlo.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم الغاء حفظ الترحيب","md",true)   
end 
Redis:del(Thepirlo.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(Thepirlo.."pirlo:Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم حفظ ترحيب المجموعه","md",true)     
end
if Redis:get(Thepirlo.."pirlo:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(Thepirlo.."pirlo:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(Thepirlo.."pirlo:Group:Rules" .. msg_chat_id,text) 
Redis:del(Thepirlo.."pirlo:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم حفظ قوانين المجموعه","md",true)  
end  
if Redis:get(Thepirlo.."pirlo:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(Thepirlo.."pirlo:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
local test = Redis:get(Thepirlo.."pirlo:Text:Manager"..msg.sender.user_id..":"..msg_chat_id.."")
if Redis:get(Thepirlo.."pirlo:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(Thepirlo.."pirlo:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(Thepirlo.."pirlo:Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(Thepirlo.."pirlo:Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Thepirlo.."pirlo:Add:Rd:Manager:Text"..test..msg_chat_id, text)  
end  
if msg.content.audio then
Redis:set(Thepirlo.."pirlo:Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(Thepirlo.."pirlo:Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
end
if msg.content.animation then
Redis:set(Thepirlo.."pirlo:Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
end
if msg.content.video_note then
Redis:set(Thepirlo.."pirlo:Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.video then
Redis:set(Thepirlo.."pirlo:Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
end
if msg.content.photo then
...
print(idPhoto)
Redis:set(Thepirlo.."pirlo:Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
end
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم حفظ رد للمدير بنجاح \n‹ : ارسل ( "..test.." ) لرئية الرد","md",true)  
end  
end
if text and text:match("^(.*)$") then
if Redis:get(Thepirlo.."pirlo:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(Thepirlo.."pirlo:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(Thepirlo.."pirlo:Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(Thepirlo.."pirlo:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(Thepirlo.."pirlo:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(Thepirlo.."pirlo:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(Thepirlo.."pirlo:Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(Thepirlo.."pirlo:Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(Thepirlo.."pirlo:Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(Thepirlo.."pirlo:Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(Thepirlo.."pirlo:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(Thepirlo.."pirlo:Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:sadd(Thepirlo.."pirlo:List:Manager"..msg_chat_id.."", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(Thepirlo.."pirlo:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(Thepirlo.."pirlo:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(Thepirlo.."pirlo:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(Thepirlo.."pirlo:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(Thepirlo.."pirlo:Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(Thepirlo.."pirlo:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(Thepirlo.."pirlo:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(Thepirlo.."pirlo:List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم حذف الرد من ردود المدير ","md",true)  
return false
end
end
if text and Redis:get(Thepirlo.."pirlo:Status:ReplySudo"..msg_chat_id) then
local anemi = Redis:get(Thepirlo.."pirlo:Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(Thepirlo.."pirlo:Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(Thepirlo.."pirlo:Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(Thepirlo.."pirlo:Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(Thepirlo.."pirlo:Add:Rd:Sudo:Photo"..text)
local video = Redis:get(Thepirlo.."pirlo:Add:Rd:Sudo:Video"..text)
local document = Redis:get(Thepirlo.."pirlo:Add:Rd:Sudo:File"..text)
local audio = Redis:get(Thepirlo.."pirlo:Add:Rd:Sudo:Audio"..text)
local video_note = Redis:get(Thepirlo.."pirlo:Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(Thepirlo..'pirlo:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(Thepirlo..'pirlo:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
if text and Redis:get(Thepirlo.."pirlo:Status:Reply"..msg_chat_id) then
local anemi = Redis:get(Thepirlo.."pirlo:Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(Thepirlo.."pirlo:Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(Thepirlo.."pirlo:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(Thepirlo.."pirlo:Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(Thepirlo.."pirlo:Add:Rd:Manager:Photo"..text..msg_chat_id)
local video = Redis:get(Thepirlo.."pirlo:Add:Rd:Manager:Video"..text..msg_chat_id)
local document = Redis:get(Thepirlo.."pirlo:Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(Thepirlo.."pirlo:Add:Rd:Manager:Audio"..text..msg_chat_id)
local video_note = Redis:get(Thepirlo.."pirlo:Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(Thepirlo..'pirlo:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(Thepirlo.."pirlo:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(Thepirlo.."pirlo:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(Thepirlo.."pirlo:Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(Thepirlo.."pirlo:Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(Thepirlo.."pirlo:Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
end   
if msg.content.animation then   
Redis:set(Thepirlo.."pirlo:Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Thepirlo.."pirlo:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content.audio then
Redis:set(Thepirlo.."pirlo:Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(Thepirlo.."pirlo:Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
end
if msg.content.video then
Redis:set(Thepirlo.."pirlo:Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
end
if msg.content.video_note then
Redis:set(Thepirlo.."pirlo:Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
Redis:set(Thepirlo.."pirlo:Add:Rd:Sudo:Photo"..test, idPhoto)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(Thepirlo.."pirlo:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(Thepirlo.."pirlo:Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(Thepirlo.."pirlo:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(Thepirlo.."pirlo:List:Rd:Sudo", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(Thepirlo.."pirlo:Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
for k,v in pairs(list) do
Redis:del(Thepirlo..'pirlo:'..v..text)
end
Redis:del(Thepirlo.."pirlo:Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(Thepirlo.."pirlo:List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم حذف الرد من ردود المطور","md",true)  
end
end
if Redis:get(Thepirlo.."pirlo:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(Thepirlo.."pirlo:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n‹ : تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(Thepirlo.."pirlo:ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(Thepirlo.."pirlo:PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(Thepirlo.."pirlo:PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(Thepirlo.."pirlo:PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(Thepirlo.."pirlo:PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(Thepirlo.."pirlo:PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(Thepirlo.."pirlo:PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(Thepirlo.."pirlo:PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(Thepirlo.."pirlo:PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v,0,text,"md",true)
Redis:set(Thepirlo.."pirlo:PinMsegees:"..v,text)
end
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Thepirlo.."pirlo:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(Thepirlo.."pirlo:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n‹ : تم الغاء الاذاعه خاص","md",true)  
end 
local list = Redis:smembers(Thepirlo..'pirlo:Num:User:Pv')  
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Thepirlo.."pirlo:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(Thepirlo.."pirlo:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n‹ : تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(Thepirlo.."pirlo:ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Thepirlo.."pirlo:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(Thepirlo.."pirlo:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Thepirlo.."pirlo:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(Thepirlo.."pirlo:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(Thepirlo..'pirlo:GetTexting:DevThepirlo'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر' then 
Redis:del(Thepirlo..'pirlo:GetTexting:DevThepirlo'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم الغاء حفظ كليشة المطور')
end
Redis:set(Thepirlo..'pirlo:Texting:DevThepirlo',text)
Redis:del(Thepirlo..'pirlo:GetTexting:DevThepirlo'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم حفظ كليشة المطور')
end
if Redis:get(Thepirlo.."pirlo:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n‹ : تم الغاء امر تعين الايدي","md",true)  
Redis:del(Thepirlo.."pirlo:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(Thepirlo.."pirlo:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(Thepirlo.."pirlo:Set:Id:Group"..msg.chat_id,text:match("(.*)"))
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if Redis:get(Thepirlo.."pirlo:Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(Thepirlo.."pirlo:Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n‹ : تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(Thepirlo.."pirlo:Change:Name:Bot"..msg.sender.user_id) 
Redis:set(Thepirlo.."pirlo:Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "‹ : تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(Thepirlo.."pirlo:Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(Thepirlo.."pirlo:Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n‹ : تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(Thepirlo.."pirlo:Change:Start:Bot"..msg.sender.user_id) 
Redis:set(Thepirlo.."pirlo:Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "‹ : تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(Thepirlo.."pirlo:Game:Smile"..msg.chat_id) then
if text == Redis:get(Thepirlo.."pirlo:Game:Smile"..msg.chat_id) then
Redis:incrby(Thepirlo.."pirlo:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Thepirlo.."pirlo:Game:Smile"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : لقد فزت في اللعبه \n‹ : اللعب مره اخره وارسل - سمايل او سمايلات","md",true)
end
end 
if Redis:get(Thepirlo.."Game:Countrygof"..msg.chat_id) then
if text == Redis:get(Thepirlo.."Game:Countrygof"..msg.chat_id) then
Redis:incrby(Thepirlo.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Thepirlo.."Game:Countrygof"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : لقد فزت في اللعبه \n‹ : العب مره اخره وارسل - اعلام","md",true)  
end
end
if Redis:get(Thepirlo.."mshaher"..msg.chat_id) then
if text == Redis:get(Thepirlo.."mshaher"..msg.chat_id) then
Redis:del(Thepirlo.."mshaher"..msg.chat_id)
Redis:incrby(Thepirlo.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : لقد فزت في اللعبه \n‹ : العب مره اخره وارسل - بوب او مشاهير","md",true)  
end
end
if Redis:get(Thepirlo.."Game:enkliz"..msg.chat_id) then
if text == Redis:get(Thepirlo.."Game:enkliz"..msg.chat_id) then
Redis:incrby(Thepirlo.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Thepirlo.."Game:enkliz"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : لقد فزت في اللعبه \n‹ : العب مره اخره وارسل - انجليزي","md",true)  
end
end
if Redis:get(Thepirlo.."pirlo:Game:Monotonous"..msg.chat_id) then
if text == Redis:get(Thepirlo.."pirlo:Game:Monotonous"..msg.chat_id) then
Redis:del(Thepirlo.."pirlo:Game:Monotonous"..msg.chat_id)
Redis:incrby(Thepirlo.."pirlo:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : لقد فزت في اللعبه \n‹ : اللعب مره اخره وارسل - الاسرع او ترتيب","md",true)  
end
end 
if Redis:get(Thepirlo.."pirlo:Game:Riddles"..msg.chat_id) then
if text == Redis:get(Thepirlo.."pirlo:Game:Riddles"..msg.chat_id) then
Redis:incrby(Thepirlo.."pirlo:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Thepirlo.."pirlo:Game:Riddles"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : لقد فزت في اللعبه \n‹ : اللعب مره اخره وارسل - حزوره","md",true)  
end
end
if Redis:get(Thepirlo.."pirlo:Game:Meaningof"..msg.chat_id) then
if text == Redis:get(Thepirlo.."pirlo:Game:Meaningof"..msg.chat_id) then
Redis:incrby(Thepirlo.."pirlo:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Thepirlo.."pirlo:Game:Meaningof"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : لقد فزت في اللعبه \n‹ : اللعب مره اخره وارسل - معاني","md",true)   
end
end
if Redis:get(Thepirlo.."pirlo:Game:Reflection"..msg.chat_id) then
if text == Redis:get(Thepirlo.."pirlo:Game:Reflection"..msg.chat_id) then
Redis:incrby(Thepirlo.."pirlo:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Thepirlo.."pirlo:Game:Reflection"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : لقد فزت في اللعبه \n‹ : اللعب مره اخره وارسل - العكس","md",true)  
end
end
if Redis:get(Thepirlo.."pirlo:Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(Thepirlo.."pirlo:Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(Thepirlo.."pirlo:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(Thepirlo.."pirlo:Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(Thepirlo.."pirlo:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(Thepirlo.."pirlo:SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(Thepirlo.."pirlo:SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(Thepirlo.."pirlo:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(Thepirlo.."pirlo:Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(Thepirlo.."pirlo:Game:Difference"..msg.chat_id) then
if text == Redis:get(Thepirlo.."pirlo:Game:Difference"..msg.chat_id) then 
Redis:del(Thepirlo.."pirlo:Game:Difference"..msg.chat_id)
Redis:incrby(Thepirlo.."pirlo:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(Thepirlo.."pirlo:Game:Example"..msg.chat_id) then
if text == Redis:get(Thepirlo.."pirlo:Game:Example"..msg.chat_id) then 
Redis:del(Thepirlo.."pirlo:Game:Example"..msg.chat_id)
Redis:incrby(Thepirlo.."pirlo:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ''..Redis:get(Thepirlo..'pirlo:Channel:Join:Name')..'', url = 't.me/'..Redis:get(Thepirlo..'pirlo:Channel:Join')}, },}}
...
if tonumber(Thepirlo) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(Thepirlo..'pirlo:Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(Thepirlo.."pirlo:ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(Thepirlo.."pirlo:TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(Thepirlo.."pirlo:Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(Thepirlo.."pirlo:Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(Thepirlo.."pirlo:Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(Thepirlo.."pirlo:Distinguished:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(Thepirlo) then 
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(Thepirlo.."pirlo:ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(Thepirlo.."pirlo:Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(Thepirlo.."pirlo:Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(Thepirlo.."pirlo:Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(Thepirlo.."pirlo:TheBasics:Group"..idg,idASAS)
end;end
end
...
if (Redis:get(Thepirlo..'pirlo:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == 'الغاء الامر' then 
Redis:del(Thepirlo..'pirlo:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id)
...
local StatusMember = LuaTele.getChatMember(UserId_Info.id,Thepirlo).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(Thepirlo..'pirlo:Channel:Join',ChannelUser) 
Redis:set(Thepirlo..'pirlo:Channel:Join:Name',UserId_Info.title) 
...
Redis:set(Thepirlo..'pirlo:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(Thepirlo..'pirlo:Channel:Join')
...
local Groups = Redis:smembers(Thepirlo..'pirlo:ChekBotAdd')  
local UsersBot = Redis:smembers(Thepirlo..'pirlo:Num:User:Pv')  
local Get_Json = '{"BotId": '..Thepirlo..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(Thepirlo.."pirlo:TheBasics:Group"..v)
local Constructor = Redis:smembers(Thepirlo.."pirlo:Originators:Group"..v)
local Manager = Redis:smembers(Thepirlo.."pirlo:Managers:Group"..v)
local Admin = Redis:smembers(Thepirlo.."pirlo:Addictive:Group"..v)
local Vips = Redis:smembers(Thepirlo.."pirlo:Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
if (Redis:get(Thepirlo.."pirlo:AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == '『 الغاء الامر 』' then   
Redis:del(Thepirlo.."pirlo:AddSudosNew"..msg_chat_id)
...
Redis:set(Thepirlo.."pirlo:AddSudosNew"..msg_chat_id,true)
...
listrep = Redis:smembers(Thepirlo.."pirlo:List:Manager"..ide.."")
if k == 1 then
...
if Redis:get(Thepirlo.."pirlo:Add:Rd:Manager:Gif"..v..ide) then
db = "gif@"..Redis:get(Thepirlo.."pirlo:Add:Rd:Manager:Gif"..v..ide)
elseif Redis:get(Thepirlo.."pirlo:Add:Rd:Manager:Vico"..v..ide) then
db = "Vico@"..Redis:get(Thepirlo.."pirlo:Add:Rd:Manager:Vico"..v..ide)
elseif Redis:get(Thepirlo.."pirlo:Add:Rd:Manager:Stekrs"..v..ide) then
db = "Stekrs@"..Redis:get(Thepirlo.."pirlo:Add:Rd:Manager:Stekrs"..v..ide)
elseif Redis:get(Thepirlo.."pirlo:Add:Rd:Manager:Text"..v..ide) then
db = "Text@"..Redis:get(Thepirlo.."pirlo:Add:Rd:Manager:Text"..v..ide)
db = string.gsub(db,'"','')
db = string.gsub(db,"'",'')
db = string.gsub(db,'*','')
db = string.gsub(db,'`','')
...
db = string.gsub(db,'}','')
db = string.gsub(db,'\n',' ')
elseif Redis:get(Thepirlo.."pirlo:Add:Rd:Manager:Photo"..v..ide) then
db = "Photo@"..Redis:get(Thepirlo.."pirlo:Add:Rd:Manager:Photo"..v..ide) 
elseif Redis:get(Thepirlo.."pirlo:Add:Rd:Manager:Video"..v..ide) then
db = "Video@"..Redis:get(Thepirlo.."pirlo:Add:Rd:Manager:Video"..v..ide)
elseif Redis:get(Thepirlo.."pirlo:Add:Rd:Manager:File"..v..ide) then
db = "File@"..Redis:get(Thepirlo.."pirlo:Add:Rd:Manager:File"..v..ide)
elseif Redis:get(Thepirlo.."pirlo:Add:Rd:Manager:Audio"..v..ide) then
db = "Audio@"..Redis:get(Thepirlo.."pirlo:Add:Rd:Manager:Audio"..v..ide)
elseif Redis:get(Thepirlo.."pirlo:Add:Rd:Manager:video_note"..v..ide) then
db = "video_note@"..Redis:get(Thepirlo.."pirlo:Add:Rd:Manager:video_note"..v..ide)
end
v = string.gsub(v,'"','')
v = string.gsub(v,"'",'')
...
Redis:sadd(Thepirlo.."pirlo:List:Manager"..GroupId,k)
if v and v:match('gif@(.*)') then
Redis:set(Thepirlo.."pirlo:Add:Rd:Manager:Gif"..k..GroupId,v:match('gif@(.*)'))
elseif v and v:match('Vico@(.*)') then
Redis:set(Thepirlo.."pirlo:Add:Rd:Manager:Vico"..k..GroupId,v:match('Vico@(.*)'))
elseif v and v:match('Stekrs@(.*)') then
Redis:set(Thepirlo.."pirlo:Add:Rd:Manager:Stekrs"..k..GroupId,v:match('Stekrs@(.*)'))
elseif v and v:match('Text@(.*)') then
Redis:set(Thepirlo.."pirlo:Add:Rd:Manager:Text"..k..GroupId,v:match('Text@(.*)'))
elseif v and v:match('Photo@(.*)') then
Redis:set(Thepirlo.."pirlo:Add:Rd:Manager:Photo"..k..GroupId,v:match('Photo@(.*)'))
elseif v and v:match('Video@(.*)') then
Redis:set(Thepirlo.."pirlo:Add:Rd:Manager:Video"..k..GroupId,v:match('Video@(.*)'))
elseif v and v:match('File@(.*)') then
Redis:set(Thepirlo.."pirlo:Add:Rd:Manager:File"..k..GroupId,v:match('File@(.*)') )
elseif v and v:match('Audio@(.*)') then
Redis:set(Thepirlo.."pirlo:Add:Rd:Manager:Audio"..k..GroupId,v:match('Audio@(.*)'))
elseif v and v:match('video_note@(.*)') then
Redis:set(Thepirlo.."pirlo:Add:Rd:Manager:video_note"..k..GroupId,v:match('video_note@(.*)') )
end
end
end
end
...
Redis:set(Thepirlo..'pirlo:Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
local photo = LuaTele.getUserProfilePhotos(Thepirlo)
local UserInfo = LuaTele.getUser(Thepirlo)
for Name_User in string.gmatch(UserInfo.first_name, "[^%s]+" ) do
UserInfo.first_name = Name_User
break
end 
NamesBot = (Redis:get(Thepirlo.."pirlo:Name:Bot") or "الروكس")
Groups = (Redis:scard(Thepirlo..'pirlo:ChekBotAdd') or 0)
Users = (Redis:scard(Thepirlo..'pirlo:Num:User:Pv') or 0)
...
{
{text = Jabwa, url = 'https://t.me/s_l_3'}, 
},
{
{text = Grosupsw, url = 'https://t.me/c_p_8'}, 
},
{
{text = Usperos, url = 'https://t.me/c_p_8'}, 
},
}
...
local NumAdd = Redis:get(Thepirlo.."pirlo:Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(Thepirlo.."pirlo:Num:Add:Games"..msg.chat_id..UserId) or 0
if Get_Is_Id then
...
if Redis:sismember(Thepirlo.."pirlo:ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(Thepirlo..'pirlo:Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'⌔ : عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(Thepirlo..'pirlo:Num:Add:Bot'),"md",true)  
end
...
if UserInfo.first_name ~= "" then
Redis:sadd(Thepirlo.."pirlo:TheBasicsQ:Group"..msg_chat_id,v.member_id.user_id) 
end
end
end
Redis:sadd(Thepirlo.."pirlo:TheBasicsQ:Group"..msg_chat_id,msg.sender.user_id) 
Redis:sadd(Thepirlo.."pirlo:ChekBotAdd",msg_chat_id)
Redis:set(Thepirlo.."pirlo:Status:Id"..msg_chat_id,true) ;Redis:set(Thepirlo.."pirlo:Status:Reply"..msg_chat_id,true) ;Redis:set(Thepirlo.."pirlo:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(Thepirlo.."pirlo:Status:BanId"..msg_chat_id,true) ;Redis:set(Thepirlo.."pirlo:Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(Thepirlo.."pirlo:BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(Thepirlo.."pirlo:ChekBotAdd",msg_chat_id) then
...
Redis:srem(Thepirlo.."pirlo:ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(Thepirlo.."pirlo:ChekBotAdd",msg_chat_id) then
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n*‹ : اهلا بك مجددا عزيزي \n‹ : اليك الازرار الخاصه بأوامر التسليه الخاصه بسورس    ‹ ︙𝔇ℜ𝔞𝔤𝔬𝔫 𝔱𝔢𝔞𝔪 .فقط اضغط على الامر الذي تريد تنفيذه *','md', true, false, false, false, reply_markup)
end
...
Redis:set(Thepirlo.."lockalllll"..msg_chat_id,"off")
...
Redis:set(Thepirlo.."lockalllll"..msg_chat_id,"on")
...
if Redis:get(Thepirlo.."lockalllll"..msg_chat_id) == "on" then
if not msg.Addictive then
...
Redis:del(Thepirlo..'Abs:gif:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل المتحركه'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(Thepirlo..'Abs:gif:Abs'..msg.chat_id,true)  
end
if text and (text == "متحركه" or text == "↫ متحركه ✯") and not Redis:get(Thepirlo..'Abs:gif:Abs'..msg.chat_id) then
...
local F333F = ' \n‹ : تم تفعيل الميمز'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(Thepirlo..'Abs:memz:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل الميمز'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(Thepirlo..'Abs:memz:Abs'..msg.chat_id,true)  
end
if text and (text == "ميمز" or text == "↫ ميمز ✯") and not Redis:get(Thepirlo..'Abs:memz:Abs'..msg.chat_id) then
...
local F333F = ' \n‹ : تم تفعيل الريمكس'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(Thepirlo..'Abs:Remix:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل الريمكس'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(Thepirlo..'Abs:Remix:Abs'..msg.chat_id,true)  
end
...
local F333F = ' \n‹ : تم تفعيل الصوره'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(Thepirlo..'Abs:Photo:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل الصوره'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(Thepirlo..'Abs:Photo:Abs'..msg.chat_id,true)  
end
if text and (text == "صوره" or text == "↫ صوره ✯") and not Redis:get(Thepirlo..'Abs:Photo:Abs'..msg.chat_id) then
...
local F333F = ' \n‹ : تم تفعيل الانمي'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(Thepirlo..'Abs:Anime:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل الانمي'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(Thepirlo..'Abs:Anime:Abs'..msg.chat_id,true)  
end
if text and (text == "انمي" or text == "↫ انمي ✯") and not Redis:get(Thepirlo..'Abs:Anime:Abs'..msg.chat_id) then
...
local F333F = ' \n‹ : تم تفعيل الافلام'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(Thepirlo..'Abs:Movies:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل الافلام'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(Thepirlo..'Abs:Movies:Abs'..msg.chat_id,true)  
end
if text and (text == "فلم" or text == "↫ فلم ✯") and not Redis:get(Thepirlo..'Abs:Movies:Abs'..msg.chat_id) then
...
local F333F = ' \n‹ : تم تفعيل المسلسلات'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(Thepirlo..'Abs:Series:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل المسلسلات'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(Thepirlo..'Abs:Series:Abs'..msg.chat_id,true)  
end
if text and (text == "مسلسل" or text == "↫ مسلسل ✯") and not Redis:get(Thepirlo..'Abs:Series:Abs'..msg.chat_id) then
...
if text == 'بايو' and not Redis:get(Thepirlo..'idnotmembio'..msg.chat_id)  then
...
if Redis:get(Thepirlo..'idnotmembio'..msg.chat_id)  then
LuaTele.sendText(msg_chat_id,msg_id, '‹ : تم تعطيل امر البايو مسبقا\n ✓',"md")
else
Redis:set(Thepirlo.."idnotmembio"..msg.chat_id,"true")
...
if not Redis:get(Thepirlo..'idnotmembio'..msg.chat_id)  then
LuaTele.sendText(msg_chat_id,msg_id, '‹ : تم تفعيل امر البايو مسبقا\n ✓',"md")
else
Redis:del(Thepirlo.."idnotmembio"..msg.chat_id)
...
if Redis:get(Thepirlo..":"..msg.sender.user_id..":lov_Bots"..msg.chat_id) == "sendlove" then
...
Redis:del(Thepirlo..":"..msg.sender.user_id..":lov_Bots"..msg.chat_id)
end
if Redis:get(Thepirlo..":"..msg.sender.user_id..":lov_Bottts"..msg.chat_id) == "sendlove" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '‹ : اليك النتائج الخـاصة :\n\n‹ : نسبة الغباء  : *'..text..'* '..sendnum..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(Thepirlo..":"..msg.sender.user_id..":lov_Bottts"..msg.chat_id)
end
if Redis:get(Thepirlo..":"..msg.sender.user_id..":lov_Botttuus"..msg.chat_id) == "sendlove" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '‹ : اليك النتائج الخـاصة :\n\n‹ : نسبة الذكاء  : *'..text..'* '..sendnum..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(Thepirlo..":"..msg.sender.user_id..":lov_Botttuus"..msg.chat_id)
end
if text and Redis:get(Thepirlo..":"..msg.sender.user_id..":krh_Bots"..msg.chat_id) == "sendkrhe" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '⌯ اليك النتائج الخـاصة :\n\n⌯ نسبه الكرة : *'..text..'* '..sendnum..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(Thepirlo..":"..msg.sender.user_id..":krh_Bots"..msg.chat_id)
end
if text and text ~="نسبه الرجوله" and Redis:get(Thepirlo..":"..msg.sender.user_id..":rjo_Bots"..msg.chat_id) == "sendrjoe" then
numj = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","🥰 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnuj = numj[math.random(#numj)]
local tttttt = '‹ : اليك النتائج الخـاصة :\n\n‹ : نسبة الرجوله لـ : *'..text..'* '..sendnuj..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(Thepirlo..":"..msg.sender.user_id..":rjo_Bots"..msg.chat_id)
end
if text and text ~="نسبه الانوثه" and Redis:get(Thepirlo..":"..msg.sender.user_id..":ano_Bots"..msg.chat_id) == "sendanoe" then
numj = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","?? 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnuj = numj[math.random(#numj)]
local tttttt = '‹ : اليك النتائج الخـاصة :\n\n‹ : نسبه الانوثة لـ : *'..text..'* '..sendnuj..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(Thepirlo..":"..msg.sender.user_id..":ano_Bots"..msg.chat_id)
end

if text == "نسبه الحب" or text == "نسبه حب" and msg.reply_to_message_id ~= 0 then
if not Redis:get(Thepirlo.."AlNsb"..msg.chat_id) then    
Redis:set(Thepirlo..":"..msg.sender.user_id..":lov_Bots"..msg.chat_id,"sendlove")
...
if not Redis:get(Thepirlo.."AlNsb"..msg.chat_id) then    
Redis:set(Thepirlo..":"..msg.sender.user_id..":lov_Bottts"..msg.chat_id,"sendlove")
...
if not Redis:get(Thepirlo.."AlNsb"..msg.chat_id) then    
Redis:set(Thepirlo..":"..msg.sender.user_id..":lov_Botttuus"..msg.chat_id,"sendlove")
hggg = '‹ : الان ارسل اسم الشخص :'
LuaTele.sendText(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(Thepirlo.."AlNsb"..msg.chat_id) then    
Redis:set(Thepirlo..":"..msg.sender.user_id..":krh_Bots"..msg.chat_id,"sendkrhe")
hggg = '‹ : الان ارسل اسمك واسم الشخص الثاني :'
LuaTele.sendText(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(Thepirlo.."AlNsb"..msg.chat_id) then    
Redis:set(Thepirlo..":"..msg.sender.user_id..":rjo_Bots"..msg.chat_id,"sendrjoe")
hggg = '‹ : الان ارسل اسم الشخص :'
LuaTele.sendText(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(Thepirlo.."AlNsb"..msg.chat_id) then    
Redis:set(Thepirlo..":"..msg.sender.user_id..":ano_Bots"..msg.chat_id,"sendanoe")
hggg = '‹ : الان ارسل اسم الشخص :'
LuaTele.sendText(msg_chat_id,msg_id,hggg) 
return false
end
...
if Redis:get(Thepirlo..'AlNsb'..msg.chat_id)  then
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم تعطيل النسب مسبقا\n ✓',"md")
else
Redis:set(Thepirlo.."AlNsb"..msg.chat_id,"true")
...
Redis:del(Thepirlo.."AlNsb"..msg.chat_id)
...
if Redis:get(Thepirlo..'myphoto'..msg.chat_id)  then
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم تعطيل صورتي مسبقا\n ✓',"md")
else
Redis:set(Thepirlo.."myphoto"..msg.chat_id,"off")
...
if not Redis:get(Thepirlo..'myphoto'..msg.chat_id)  then
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم تفعيل صورتي مسبقا\n ✓',"md")
else
Redis:del(Thepirlo.."myphoto"..msg.chat_id)
...
Redis:del(Thepirlo.."mybuti"..msg_chat_id)
...
Redis:set(Thepirlo.."mybuti"..msg_chat_id,"off")
...
Redis:del(Thepirlo.."sayy"..msg_chat_id)
...
Redis:set(Thepirlo.."sayy"..msg_chat_id,"off")
LuaTele.sendText(msg_chat_id,msg_id,'\n*‹ : تم امر امر كول * ',"md",true)  
end
if text == "جمالي" or text == 'نسبه جمالي' then
if Redis:get(Thepirlo.."mybuti"..msg_chat_id) == "off" then
...
if Redis:get(Thepirlo.."sayy"..msg_chat_id) == "off" then
...
if text == "صورتي" then
if Redis:get(Thepirlo.."myphoto"..msg_chat_id) == "off" then
...
Redis:set(Thepirlo.."pirlo:Set:Id:Group"..msg.chat_id,Text_Rand)
...
if not Redis:get(Thepirlo.."pirlo:Status:Id"..msg_chat_id) then
return false
end
local InfoUser = LuaTele.getUserFullInfo(msg.sender.user_id)
if InfoUser.bio then
...
local TotalMsg = Redis:get(Thepirlo..'pirlo:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(Thepirlo..'pirlo:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(Thepirlo.."pirlo:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(Thepirlo.."pirlo:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
local Texting = {
'صورتك فدشي خيالي',
"شتحس مخلي هلصورا ؟ ",
"محتحت اقسم",
...
Get_Is_Id = Redis:get(Thepirlo.."pirlo:Set:Id:Group"..msg_chat_id)
if Redis:get(Thepirlo.."pirlo:Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
...
local TotalMsg = Redis:get(Thepirlo..'pirlo:Num:Message:User'..msg_chat_id..':'..Message_Reply.sender.user_id) or 0
local TotalEdit = Redis:get(Thepirlo..'pirlo:Num:Message:Edit'..msg_chat_id..Message_Reply.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*‹ : ايديه : '..UserId..
...
local TotalMsg = Redis:get(Thepirlo..'pirlo:Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
local TotalEdit = Redis:get(Thepirlo..'pirlo:Num:Message:Edit'..msg_chat_id..UserId_Info.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*‹ : ايديه : '..UserId..
'\n‹ : معرفه : @'..UserName..
...
{{text =news,url = "https://t.me/c_p_8"}, },}}
...
local UserId = msg.sender.user_id
local RinkBot = msg.Name_Controller
local TotalMsg = Redis:get(Thepirlo..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,Thepirlo).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : البوت عضو في المجموعه ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,Thepirlo).status
if GetMemberStatus.can_change_info then
change_info = '❬ ✔️ ❭' else change_info = '❬ ❌ ❭'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(Thepirlo.."pirlo:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(Thepirlo.."pirlo:DevelopersQ:Groups",UserId_Info.id) 
...
if not Redis:sismember(Thepirlo.."pirlo:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(Thepirlo.."pirlo:Developers:Groups",UserId_Info.id) 
...
if not Redis:sismember(Thepirlo.."pirlo:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(Thepirlo.."pirlo:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Thepirlo.."pirlo:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(Thepirlo.."pirlo:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Thepirlo.."pirlo:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(Thepirlo.."pirlo:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Thepirlo.."pirlo:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(Thepirlo.."pirlo:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Thepirlo.."pirlo:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(Thepirlo.."pirlo:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Thepirlo.."pirlo:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(Thepirlo.."pirlo:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Thepirlo.."pirlo:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Thepirlo.."pirlo:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Thepirlo.."pirlo:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(Thepirlo.."pirlo:Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Thepirlo.."pirlo:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(Thepirlo.."pirlo:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Thepirlo.."pirlo:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Thepirlo.."pirlo:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Thepirlo.."pirlo:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Thepirlo.."pirlo:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Thepirlo.."pirlo:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Thepirlo.."pirlo:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Thepirlo.."pirlo:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Thepirlo.."pirlo:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Thepirlo.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Thepirlo.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Thepirlo.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : الحمار هاذا بطل يصفن ").Reply,"md",true)  
else
Redis:srem(Thepirlo.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "قرد" then
if not Redis:sismember(Thepirlo.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Thepirlo.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Thepirlo.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Thepirlo.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "ملك" then
if not Redis:sismember(Thepirlo.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Thepirlo.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Thepirlo.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Thepirlo.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Thepirlo.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : يارب تعقل وتبقا ذكي 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(Thepirlo.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Thepirlo.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : اعقل بقا 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(Thepirlo.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Thepirlo.."pirlo:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Thepirlo.."pirlo:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Thepirlo.."pirlo:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(Thepirlo.."pirlo:DevelopersQ:Groups",UserId) 
...
if not Redis:sismember(Thepirlo.."pirlo:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(Thepirlo.."pirlo:Developers:Groups",UserId) 
...
if not Redis:sismember(Thepirlo.."pirlo:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(Thepirlo.."pirlo:TheBasicsW:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Thepirlo.."pirlo:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(Thepirlo.."pirlo:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Thepirlo.."pirlo:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(Thepirlo.."pirlo:Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Thepirlo.."pirlo:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(Thepirlo.."pirlo:Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Thepirlo.."pirlo:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(Thepirlo.."pirlo:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Thepirlo.."pirlo:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(Thepirlo.."pirlo:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Thepirlo.."pirlo:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم ترقيته مطوࢪ بنجاح ✓ ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Thepirlo.."pirlo:DevelopersQ:Groups",UserId_Info.id) 
...
if Redis:sismember(Thepirlo.."pirlo:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم ترقيته مطوࢪ بنجاح ✓ مسبقا ").Reply,"md",true)  
else
Redis:sadd(Thepirlo.."pirlo:Developers:Groups",UserId_Info.id) 
...
if Redis:sismember(Thepirlo.."pirlo:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(Thepirlo.."pirlo:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Thepirlo.."pirlo:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
...
Redis:sadd(Thepirlo.."pirlo:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Thepirlo.."pirlo:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم ترقيته منشئ بنجاح ✓ مسبقا ").Reply,"md",true)  
else
Redis:sadd(Thepirlo.."pirlo:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Thepirlo.."pirlo:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم ترقيته مدير مسبقآ ✓   ").Reply,"md",true)  
else
Redis:sadd(Thepirlo.."pirlo:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Originators and not Redis:get(Thepirlo.."pirlo:Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(Thepirlo.."pirlo:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم ترقيته ادمن مسبقآ ✓   ").Reply,"md",true)  
else
Redis:sadd(Thepirlo.."pirlo:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Thepirlo.."pirlo:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم ترقيته مميز مسبقآ ✓   ").Reply,"md",true)  
else
Redis:sadd(Thepirlo.."pirlo:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Thepirlo.."pirlo:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Thepirlo.."pirlo:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Thepirlo.."pirlo:Developers:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Thepirlo.."pirlo:Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Thepirlo.."pirlo:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(Thepirlo.."pirlo:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Thepirlo.."pirlo:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Thepirlo.."pirlo:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم ترقيته منشئ اساسي بنجاح ✓").Reply,"md",true)  
end
end
if TextMsg == "منشئ" then
...
if Redis:sismember(Thepirlo.."pirlo:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Thepirlo.."pirlo:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Thepirlo.."pirlo:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم ترقيته مدير مسبقآ ✓   ").Reply,"md",true)  
else
Redis:sadd(Thepirlo.."pirlo:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Thepirlo.."pirlo:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم ترقيته ادمن مسبقآ ✓   ").Reply,"md",true)  
else
Redis:sadd(Thepirlo.."pirlo:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم ترقيته ادمن بنجاح ✓  ").Reply,"md",true)  
end
end
if TextMsg == "كانسر" then
if ChannelJoin(msg) == false then
local chinfo = Redis:get(Thepirlo.."ch:admin")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ''..Redis:get(Thepirlo..'pirlo:Channel:Join:Name')..'', url = 't.me/'..Redis:get(Thepirlo..'pirlo:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n‹ : عمࢪي اشتࢪك ثم استخدم الامࢪ❗️*',"md",false, false, false, false, reply_markup)
end
if Redis:sismember(Thepirlo.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Thepirlo.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Thepirlo.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Thepirlo.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Thepirlo.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Thepirlo.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Thepirlo.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Thepirlo.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Thepirlo.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Thepirlo.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Thepirlo.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Thepirlo.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Thepirlo.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Thepirlo.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Thepirlo.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Thepirlo.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Thepirlo.."pirlo:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم ترقيته مميز مسبقآ ✓   ").Reply,"md",true)  
else
Redis:sadd(Thepirlo.."pirlo:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Thepirlo.."pirlo:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم ترقيته مطوࢪ بنجاح ✓ ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Thepirlo.."pirlo:DevelopersQ:Groups",UserId) 
...
if Redis:sismember(Thepirlo.."pirlo:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم ترقيته مطوࢪ بنجاح ✓ مسبقا ").Reply,"md",true)  
else
Redis:sadd(Thepirlo.."pirlo:Developers:Groups",UserId) 
...
if Redis:sismember(Thepirlo.."pirlo:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(Thepirlo.."pirlo:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Thepirlo.."pirlo:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم ترقيته منشئ بنجاح ✓اساسي بنجاح ✓ مسبقا ").Reply,"md",true)  
else
Redis:sadd(Thepirlo.."pirlo:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Thepirlo.."pirlo:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم ترقيته منشئ بنجاح ✓ مسبقا ").Reply,"md",true)  
else
Redis:sadd(Thepirlo.."pirlo:Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Thepirlo.."pirlo:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم ترقيته مدير مسبقآ ✓   ").Reply,"md",true)  
else
Redis:sadd(Thepirlo.."pirlo:Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Thepirlo.."pirlo:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم ترقيته ادمن مسبقآ ✓   ").Reply,"md",true)  
else
Redis:sadd(Thepirlo.."pirlo:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Thepirlo.."pirlo:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم ترقيته مميز مسبقآ ✓   ").Reply,"md",true)  
else
Redis:sadd(Thepirlo.."pirlo:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(Thepirlo.."pirlo:Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(Thepirlo.."pirlo:President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Thepirlo.."pirlo:Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Thepirlo.."pirlo:Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(Thepirlo.."pirlo:Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Thepirlo.."pirlo:Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(Thepirlo.."pirlo:DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(Thepirlo.."pirlo:Developers:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : لا يوجد مطورين حاليا , ","md",true)  
end
ListMembers = '\n*‹ : قائمه مطورين البوت \n ⋆┄┄─┄─┄─┄┄─┄─┄┄⋆*\n'
...
local Info_Members = Redis:smembers(Thepirlo.."pirlo:TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Thepirlo.."pirlo:TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : لا يوجد منشئين اساسيين حاليا , ","md",true)  
end
...
local Info_Members = Redis:smembers(Thepirlo.."pirlo:Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Thepirlo.."pirlo:Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Thepirlo.."pirlo:Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Thepirlo.."wtka:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Thepirlo.."mar:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Thepirlo.."2rd:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Thepirlo.."klb:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Thepirlo.."smb:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Thepirlo.."kholat:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Thepirlo.."8by:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Thepirlo.."3ra:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Thepirlo.."pirlo:Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Thepirlo.."pirlo:BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Thepirlo.."pirlo:BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Thepirlo.."pirlo:SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(Thepirlo.."pirlo:Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(Thepirlo.."pirlo:Status:Welcome"..msg_chat_id,true) 
...
Redis:set(Thepirlo.."pirlo:Status:Id"..msg_chat_id,true) 
...
Redis:set(Thepirlo.."pirlo:Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(Thepirlo.."pirlo:Status:Reply"..msg_chat_id,true) 
...
Redis:set(Thepirlo.."pirlo:Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(Thepirlo.."pirlo:Status:BanId"..msg_chat_id,true) 
...
Redis:set(Thepirlo.."pirlo:BotFree",true) 
...
Redis:set(Thepirlo.."pirlo:TwaslBot",true) 
...
if text and text:match("^(.*)$") then
if Redis:get(Thepirlo.."pirlo1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(Thepirlo.."pirlo1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(Thepirlo.."pirlo1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(Thepirlo.."pirlo1:List:Rd:Sudo"..msg.chat_id, text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(Thepirlo.."pirlo1:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(Thepirlo..'pirlo1:Add:Rd:Sudo:Text'..text..msg.chat_id)
Redis:del(Thepirlo..'pirlo1:Add:Rd:Sudo:Text1'..text..msg.chat_id)
Redis:del(Thepirlo..'pirlo1:Add:Rd:Sudo:Text2'..text..msg.chat_id)
Redis:del(Thepirlo.."pirlo1:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(Thepirlo.."pirlo1:List:Rd:Sudo"..msg.chat_id, text)
...
local list = Redis:smembers(Thepirlo.."pirlo1:List:Rd:Sudo"..msg.chat_id)
for k,v in pairs(list) do  
Redis:del(Thepirlo.."pirlo1:Add:Rd:Sudo:Text"..v..msg.chat_id) 
Redis:del(Thepirlo.."pirlo1:Add:Rd:Sudo:Text1"..v..msg.chat_id) 
Redis:del(Thepirlo.."pirlo1:Add:Rd:Sudo:Text2"..v..msg.chat_id) 
Redis:del(Thepirlo.."pirlo1:List:Rd:Sudo"..msg.chat_id)
end
...
Redis:set(Thepirlo.."pirlo1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(Thepirlo.."pirlo1:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(Thepirlo.."pirlo1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Thepirlo.."pirlo1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(Thepirlo.."pirlo1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Thepirlo.."pirlo1:Add:Rd:Sudo:Text"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(Thepirlo.."pirlo1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Thepirlo.."pirlo1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(Thepirlo.."pirlo1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Thepirlo.."pirlo1:Add:Rd:Sudo:Text1"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(Thepirlo.."pirlo1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Thepirlo.."pirlo1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(Thepirlo.."pirlo1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Thepirlo.."pirlo1:Add:Rd:Sudo:Text2"..test..msg.chat_id, text)  
end  
...
if text then
local Text = Redis:get(Thepirlo.."pirlo1:Add:Rd:Sudo:Text"..text..msg.chat_id)   
local Text1 = Redis:get(Thepirlo.."pirlo1:Add:Rd:Sudo:Text1"..text..msg.chat_id)   
local Text2 = Redis:get(Thepirlo.."pirlo1:Add:Rd:Sudo:Text2"..text..msg.chat_id)   
...
if text and text:match("^(.*)$") then
if Redis:get(Thepirlo.."pirlo11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ')
Redis:set(Thepirlo.."pirlo11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(Thepirlo.."pirlo11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(Thepirlo.."pirlo11:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if Redis:get(Thepirlo.."pirlo11:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف الرد من ردود المتعدده")
Redis:del(Thepirlo..'pirlo11:Add:Rd:Sudo:Text'..text)
Redis:del(Thepirlo..'pirlo11:Add:Rd:Sudo:Text1'..text)
Redis:del(Thepirlo..'pirlo11:Add:Rd:Sudo:Text2'..text)
Redis:del(Thepirlo.."pirlo11:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(Thepirlo.."pirlo11:List:Rd:Sudo", text)
return false
end
end
...
local list = Redis:smembers(Thepirlo.."pirlo11:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(Thepirlo.."pirlo11:Add:Rd:Sudo:Text"..v) 
Redis:del(Thepirlo.."pirlo11:Add:Rd:Sudo:Text1"..v) 
Redis:del(Thepirlo.."pirlo11:Add:Rd:Sudo:Text2"..v)   
Redis:del(Thepirlo.."pirlo11:List:Rd:Sudo")
end
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف ردود المتعدده")
end
...
Redis:set(Thepirlo.."pirlo11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الرد الذي اريد اضافته")
end
...
Redis:set(Thepirlo.."pirlo11:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(Thepirlo.."pirlo11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Thepirlo.."pirlo11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(Thepirlo.."pirlo11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Thepirlo.."pirlo11:Add:Rd:Sudo:Text"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
...
if text then  
local test = Redis:get(Thepirlo.."pirlo11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Thepirlo.."pirlo11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(Thepirlo.."pirlo11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Thepirlo.."pirlo11:Add:Rd:Sudo:Text1"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
...
if text then  
local test = Redis:get(Thepirlo.."pirlo11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Thepirlo.."pirlo11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(Thepirlo.."pirlo11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Thepirlo.."pirlo11:Add:Rd:Sudo:Text2"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد")
return false  
end  
...
if text then
local Text = Redis:get(Thepirlo.."pirlo11:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(Thepirlo.."pirlo11:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(Thepirlo.."pirlo11:Add:Rd:Sudo:Text2"..text)   
if Text or Text1 or Text2 then 
local texting = {
Text,
Text1,
...
Redis:sadd(Thepirlo.."pirlo:allM"..msg.chat_id, msg.id)
if Redis:get(Thepirlo.."pirlo:Status:Del:Media"..msg.chat_id) then    
local gmedia = Redis:scard(Thepirlo.."pirlo:allM"..msg.chat_id)  
if gmedia >= 200 then
local liste = Redis:smembers(Thepirlo.."pirlo:allM"..msg.chat_id)
...
Redis:del(Thepirlo.."pirlo:allM"..msg.chat_id)
end
end
end
...
local list = Redis:smembers(Thepirlo.."pirlo:allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(Thepirlo.."pirlo:allM"..msg.chat_id)  
...
Redis:del(Thepirlo.."pirlo:Status:Del:Media"..msg.chat_id)
...
Redis:set(Thepirlo.."pirlo:Status:Del:Media"..msg.chat_id,true)
...
Redis:del(Thepirlo.."pirlo:Status:yt"..msg.chat_id)
...
Redis:set(Thepirlo.."pirlo:Status:yt"..msg.chat_id,true)
...
local httpsCurl = "http://185.185.127.158/pirlo/tahaj200.php?token="..Token.."&msg="..MsgId.."&Text="..URL.escape(Ttext).."&chat_id="..msg.chat_id.."&user="..msg.sender.user_id
...
local UserId_Info = LuaTele.searchPublicChat("@c_p_8")
if UserId_Info.id then
local UserInfo = LuaTele.getUser(UserId_Info.id)
local InfoUser = LuaTele.getUserFullInfo(UserId_Info.id)
if InfoUser.bio then
...
keyboardd.inline_keyboard = {
{
{text = '❲ 𝗎𝗉𝖽𝖺𝗍𝖾’s ❳', url = "https://t.me/c_p_8"}
},
{
{text = '-   ‹ ︙𝔇ℜ𝔞𝔤𝔬𝔫 𝔱𝔢𝔞𝔪 .  𝖲𝗈𝗎𝗋𝖼𝖾 .', url='https://t.me/c_p_8'},
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
{{text = 'Delete Instagram',url="https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/"},{text = 'Delete snapchat',url="https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.pirlochat.com%2Faccounts%2Fdeleteaccount"}},{{text= ' سورس    ‹ ︙𝔇ℜ𝔞𝔤𝔬𝔫 𝔱𝔢𝔞𝔪 .',url="t.me/c_p_8"}}
}
local msg_id = msg.id/2097152/0.5
...
if text == "تاك للمطلقات" or text == "المطلقات" then
  local mutlqat_list = Redis:smembers(Thepirlo..msg_chat_id.."mutlqat:")
...
keyboard.inline_keyboard = {
{
{text = '𝗎𝗉𝖽𝖺𝗍𝖾𝗌', url = 'https://t.me/c_p_8'},{text = '. ‹   ‹ ︙𝔇ℜ𝔞𝔤𝔬𝔫 𝔱𝔢𝔞𝔪 . 𝖳𝖾𝖺𝗆', url = 'https://t.me/c_p_8'}, 
},
{
{text = 'مبࢪمج اݪسوࢪس', url = 't.me/s_l_3'}, 
},
}
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id=' .. msg.chat_id .. '&photo=https://t.me/c_p_8&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == "منو اني" then
if msg.sender.user_id == tonumber(1983379011) then
LuaTele.sendText(msg_chat_id,msg_id,"‹ : انت دراكون مطور السورس يقلبي🌚💘","md",true)
...
Redis:del(Thepirlo.."pirlo:Status:joinet"..msg_chat_id) 
...
Redis:set(Thepirlo.."pirlo:Status:joinet"..msg_chat_id,true) 
...
if TextMsg == 'الرابط' then
Redis:del(Thepirlo.."pirlo:Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم تعطيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(Thepirlo.."pirlo:Status:Welcome"..msg_chat_id) 
...
Redis:del(Thepirlo.."pirlo:Status:Id"..msg_chat_id) 
...
Redis:del(Thepirlo.."pirlo:Status:IdPhoto"..msg_chat_id) 
...
Redis:del(Thepirlo.."pirlo:Status:Reply"..msg_chat_id) 
...
Redis:del(Thepirlo.."pirlo:Status:ReplySudo"..msg_chat_id) 
...
Redis:del(Thepirlo.."pirlo:Status:BanId"..msg_chat_id) 
...
Redis:del(Thepirlo.."pirlo:Status:SetId"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم تعطيل الرفع ","md",true)
end
if TextMsg == 'الالعاب' then
Redis:del(Thepirlo.."pirlo:Status:Games"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم تعطيل الالعاب ","md",true)
end
if TextMsg == 'اطردني' then
Redis:del(Thepirlo.."pirlo:Status:KickMe"..msg_chat_id) 
...
Redis:del(Thepirlo.."pirlo:BotFree") 
...
Redis:del(Thepirlo.."pirlo:TwaslBot") 
...
if Redis:sismember(Thepirlo.."pirlo:BanAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Thepirlo.."pirlo:BanAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(Thepirlo.."pirlo:BanAll:Groups",UserId_Info.id) then
...
Redis:srem(Thepirlo.."pirlo:BanAll:Groups",UserId_Info.id) 
...
if not msg.Originators and not Redis:get(Thepirlo.."pirlo:Status:BanId"..msg_chat_id) then
...
if Redis:sismember(Thepirlo.."pirlo:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:sadd(Thepirlo.."pirlo:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
...
if not Redis:sismember(Thepirlo.."pirlo:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(Thepirlo.."pirlo:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Thepirlo.."pirlo:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:sadd(Thepirlo.."pirlo:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if not Redis:sismember(Thepirlo.."pirlo:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(Thepirlo.."pirlo:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(Thepirlo.."pirlo:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Thepirlo.."pirlo:BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Thepirlo.."pirlo:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Thepirlo.."pirlo:BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Thepirlo.."pirlo:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Thepirlo.."pirlo:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(Thepirlo.."pirlo:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Thepirlo.."pirlo:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Thepirlo.."pirlo:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Thepirlo.."pirlo:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Thepirlo.."pirlo:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Thepirlo.."pirlo:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(Thepirlo.."pirlo:BanGroup:Group"..msg_chat_id,UserId) then
...
Redis:sadd(Thepirlo.."pirlo:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(Thepirlo.."pirlo:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(Thepirlo.."pirlo:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Thepirlo.."pirlo:SilentGroup:Group"..msg_chat_id,UserId) then
...
Redis:sadd(Thepirlo.."pirlo:SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(Thepirlo.."pirlo:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(Thepirlo.."pirlo:SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if not Redis:get(Thepirlo.."pirlo:Status:KickMe"..msg_chat_id) then
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(Thepirlo.."pirlo:TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(Thepirlo.."pirlo:Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
if not msg.ControllerBot and not Redis:set(Thepirlo.."pirlo:LeftBot") then
...
Redis:set(Thepirlo.."pirlo:Lock:text"..msg_chat_id,true) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"‹ : تم قفـل الدردشه").Lock,"md",true)  
return false
end 
if text and Redis:get(Thepirlo.."addchannel"..msg.sender.user_id) == "on" then
Redis:set(Thepirlo.."chadmin"..msg_chat_id,text) 
LuaTele.sendText(msg_chat_id,msg_id,"𖥔  تم حفظ ايدي القناه","md",true)  
Redis:del(Thepirlo.."addchannel"..msg.sender.user_id)
end
if text == "القناه المضافه" then
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(Thepirlo.."chadmin"..msg_chat_id),"md",true)  
end
if text == "اضف قناه" then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖥔 هاذا الامر يخص『 '..Controller_Num(7)..' 』* ',"md",true)  
end
Redis:set(Thepirlo.."addchannel"..msg.sender.user_id,"on") 
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(Thepirlo..'Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n𖥔 عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
Redis:set(Thepirlo.."Lock:channell"..msg_chat_id,true) 
...
Redis:del(Thepirlo.."Lock:channell"..msg_chat_id)  
...
Redis:set(Thepirlo.."pirlo:Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(Thepirlo.."pirlo:Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(Thepirlo.."pirlo:Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(Thepirlo.."pirlo:Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(Thepirlo.."pirlo:Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(Thepirlo.."pirlo:lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(Thepirlo.."pirlo:Lock:edit"..msg_chat_id,true) 
...
Redis:set(Thepirlo.."pirlo:Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(Thepirlo..'pirlo:'..lock..msg_chat_id,"del")    
end
...
Redis:del(Thepirlo.."pirlo:Lock:AddMempar"..msg_chat_id)  
...
Redis:del(Thepirlo.."pirlo:Lock:text"..msg_chat_id)  
...
Redis:del(Thepirlo.."pirlo:Lock:Join"..msg_chat_id)  
...
Redis:del(Thepirlo.."pirlo:Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(Thepirlo.."pirlo:Lock:tagservr"..msg_chat_id)  
...
Redis:del(Thepirlo.."pirlo:lockpin"..msg_chat_id)  
...
Redis:del(Thepirlo.."pirlo:Lock:edit"..msg_chat_id) 
...
Redis:del(Thepirlo.."pirlo:Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(Thepirlo..'pirlo:'..lock..msg_chat_id)    
end
...
Redis:hset(Thepirlo.."pirlo:Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(Thepirlo.."pirlo:Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(Thepirlo.."pirlo:Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(Thepirlo.."pirlo:Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(Thepirlo.."pirlo:Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(Thepirlo.."pirlo:Lock:Link"..msg_chat_id,"del")  
...
Redis:set(Thepirlo.."pirlo:Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(Thepirlo.."pirlo:Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(Thepirlo.."pirlo:Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(Thepirlo.."pirlo:Lock:Link"..msg_chat_id)  
...
Redis:set(Thepirlo.."pirlo:Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(Thepirlo.."pirlo:Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(Thepirlo.."pirlo:Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(Thepirlo.."pirlo:Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(Thepirlo.."pirlo:Lock:User:Name"..msg_chat_id)  
...
Redis:set(Thepirlo.."pirlo:Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(Thepirlo.."pirlo:Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(Thepirlo.."pirlo:Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(Thepirlo.."pirlo:Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(Thepirlo.."pirlo:Lock:hashtak"..msg_chat_id)  
...
Redis:set(Thepirlo.."pirlo:Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(Thepirlo.."pirlo:Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(Thepirlo.."pirlo:Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(Thepirlo.."pirlo:Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(Thepirlo.."pirlo:Lock:Cmd"..msg_chat_id)  
...
Redis:set(Thepirlo.."pirlo:Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(Thepirlo.."pirlo:Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(Thepirlo.."pirlo:Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(Thepirlo.."pirlo:Lock:Photo"..msg_chat_id,"kick")  
...
Redis:set(Thepirlo.."pirlo:Lock:phshar"..msg_chat_id,true) 
...
Redis:set(Thepirlo..'lock:Fars'..msg.chat_id,true) 
...
Redis:del(Thepirlo.."pirlo:Lock:phshar"..msg_chat_id)  
...
Redis:del(Thepirlo..'lock:Fars'..msg.chat_id) 
...
Redis:del(Thepirlo.."pirlo:Lock:Photo"..msg_chat_id)  
...
Redis:set(Thepirlo.."pirlo:Lock:Video"..msg_chat_id,"del")  
...
Redis:set(Thepirlo.."pirlo:Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(Thepirlo.."pirlo:Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(Thepirlo.."pirlo:Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(Thepirlo.."pirlo:Lock:Video"..msg_chat_id)  
...
Redis:set(Thepirlo.."pirlo:Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(Thepirlo.."pirlo:Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(Thepirlo.."pirlo:Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(Thepirlo.."pirlo:Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(Thepirlo.."pirlo:Lock:Animation"..msg_chat_id)  
...
Redis:set(Thepirlo.."pirlo:Lock:geam"..msg_chat_id,"del")  
...
Redis:set(Thepirlo.."pirlo:Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(Thepirlo.."pirlo:Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(Thepirlo.."pirlo:Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(Thepirlo.."pirlo:Lock:geam"..msg_chat_id)  
...
Redis:set(Thepirlo.."pirlo:Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(Thepirlo.."pirlo:Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(Thepirlo.."pirlo:Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(Thepirlo.."pirlo:Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(Thepirlo.."pirlo:Lock:Audio"..msg_chat_id)  
...
Redis:set(Thepirlo.."pirlo:Lock:vico"..msg_chat_id,"del")  
...
Redis:set(Thepirlo.."pirlo:Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(Thepirlo.."pirlo:Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(Thepirlo.."pirlo:Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(Thepirlo.."pirlo:Lock:vico"..msg_chat_id)  
...
Redis:set(Thepirlo.."pirlo:Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(Thepirlo.."pirlo:Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(Thepirlo.."pirlo:Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(Thepirlo.."pirlo:Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(Thepirlo.."pirlo:Lock:Keyboard"..msg_chat_id)  
...
Redis:set(Thepirlo.."pirlo:Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(Thepirlo.."pirlo:Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(Thepirlo.."pirlo:Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(Thepirlo.."pirlo:Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(Thepirlo.."pirlo:Lock:Sticker"..msg_chat_id)  
...
Redis:set(Thepirlo.."pirlo:Lock:forward"..msg_chat_id,"del")  
...
Redis:set(Thepirlo.."pirlo:Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(Thepirlo.."pirlo:Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(Thepirlo.."pirlo:Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(Thepirlo.."pirlo:Lock:forward"..msg_chat_id)  
...
Redis:set(Thepirlo.."pirlo:Lock:Document"..msg_chat_id,"del")  
...
Redis:set(Thepirlo.."pirlo:Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(Thepirlo.."pirlo:Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(Thepirlo.."pirlo:Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(Thepirlo.."pirlo:Lock:Document"..msg_chat_id)  
...
Redis:set(Thepirlo.."pirlo:Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(Thepirlo.."pirlo:Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(Thepirlo.."pirlo:Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(Thepirlo.."pirlo:Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(Thepirlo.."pirlo:Lock:Unsupported"..msg_chat_id)  
...
Redis:set(Thepirlo.."pirlo:Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(Thepirlo.."pirlo:Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(Thepirlo.."pirlo:Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(Thepirlo.."pirlo:Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(Thepirlo.."pirlo:Lock:Markdaun"..msg_chat_id)  
...
Redis:set(Thepirlo.."pirlo:Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(Thepirlo.."pirlo:Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(Thepirlo.."pirlo:Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(Thepirlo.."pirlo:Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(Thepirlo.."pirlo:Lock:Contact"..msg_chat_id)  
...
Redis:set(Thepirlo.."pirlo:Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(Thepirlo.."pirlo:Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(Thepirlo.."pirlo:Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(Thepirlo.."pirlo:Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(Thepirlo.."pirlo:Lock:Spam"..msg_chat_id)  
...
Redis:set(Thepirlo.."pirlo:Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(Thepirlo.."pirlo:Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(Thepirlo.."pirlo:Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(Thepirlo.."pirlo:Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(Thepirlo.."pirlo:Lock:Inlen"..msg_chat_id)  
...
Redis:setex(Thepirlo.."pirlo:Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:del(Thepirlo.."pirlo:Group:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم مسح الرابط ","md",true)             
end
if text == "الرابط" then
if not Redis:get(Thepirlo.."pirlo:Status:Link"..msg_chat_id) then
...
Redis:setex(Thepirlo.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(Thepirlo.."pirlo:Status:Welcome"..msg_chat_id) then
...
Redis:del(Thepirlo.."pirlo:Welcome:Group"..msg_chat_id) 
...
Redis:setex(Thepirlo.."pirlo:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(Thepirlo.."pirlo:Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم ازالة قوانين المجموعه","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(Thepirlo.."pirlo:Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(Thepirlo.."pirlo:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(Thepirlo.."pirlo:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(Thepirlo.."pirlo:List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(Thepirlo.."pirlo:Filter:Group:"..v..msg_chat_id)  
Redis:srem(Thepirlo.."pirlo:List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(Thepirlo.."pirlo:Filter:Group:"..v..msg_chat_id)   
...
Redis:set(Thepirlo..'pirlo:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(Thepirlo..'pirlo:FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*‹ : ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(Thepirlo.."pirlo:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(Thepirlo.."pirlo:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(Thepirlo.."pirlo:Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(Thepirlo.."pirlo:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(Thepirlo.."pirlo:Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(Thepirlo.."pirlo:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
...
if Redis:get(Thepirlo.."pirlo:Status:Link"..msg.chat_id) then
Statuslink = '❬ ✔️ ❭' else Statuslink = '❬ ❌ ❭'
end
if Redis:get(Thepirlo.."pirlo:Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✔️ ❭' else StatusWelcome = '❬ ❌ ❭'
end
if Redis:get(Thepirlo.."pirlo:Status:Id"..msg.chat_id) then
StatusId = '❬ ✔️ ❭' else StatusId = '❬ ❌ ❭'
end
if Redis:get(Thepirlo.."pirlo:Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✔️ ❭' else StatusIdPhoto = '❬ ❌ ❭'
end
if Redis:get(Thepirlo.."pirlo:Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✔️ ❭' else StatusReply = '❬ ❌ ❭'
end
if Redis:get(Thepirlo.."pirlo:Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✔️ ❭' else StatusReplySudo = '❬ ❌ ❭'
end
if Redis:get(Thepirlo.."pirlo:Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✔️ ❭' else StatusBanId = '❬ ❌ ❭'
end
if Redis:get(Thepirlo.."pirlo:Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✔️ ❭' else StatusSetId = '❬ ❌ ❭'
end
if Redis:get(Thepirlo.."pirlo:Status:Games"..msg.chat_id) then
StatusGames = '❬ ✔️ ❭' else StatusGames = '❬ ❌ ❭'
end
if Redis:get(Thepirlo.."pirlo:Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✔️ ❭' else Statuskickme = '❬ ❌ ❭'
end
if Redis:get(Thepirlo.."pirlo:Status:AddMe"..msg.chat_id) then
...
Rink = 1
elseif Redis:sismember(Thepirlo.."pirlo:Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(Thepirlo.."pirlo:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(Thepirlo.."pirlo:Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(Thepirlo.."pirlo:Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(Thepirlo.."pirlo:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(Thepirlo.."pirlo:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(Thepirlo.."pirlo:Developers:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(Thepirlo.."pirlo:TheBasics:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(Thepirlo.."pirlo:Originators:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(Thepirlo.."pirlo:Managers:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(Thepirlo.."pirlo:Addictive:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(Thepirlo.."pirlo:Distinguished:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
Redis:del(Thepirlo..'pirlo:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(Thepirlo..'pirlo:Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(Thepirlo..'pirlo:Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'‹ : عدد رسائلك هنا *~ '..(Redis:get(Thepirlo..'pirlo:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'‹ : عدد التعديلات هنا *~ '..(Redis:get(Thepirlo..'pirlo:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'‹ : عدد جهاتك المضافه هنا *~ '..(Redis:get(Thepirlo.."pirlo:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(Thepirlo.."pirlo:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
‹ : ارسل الان النص
‹ : يمكنك اضافه :
...
Redis:del(Thepirlo.."pirlo:Set:Id:Group"..msg.chat_id)
...
Redis:del(Thepirlo.."pirlo:DevelopersQ:Groups") 
...
Redis:del(Thepirlo.."pirlo:Developers:Groups") 
...
Redis:del(Thepirlo.."pirlo:TheBasicsQ:Group"..msg_chat_id) 
...
Redis:del(Thepirlo.."pirlo:TheBasics:Group"..msg_chat_id) 
...
Redis:del(Thepirlo.."pirlo:Originators:Group"..msg_chat_id) 
...
Redis:del(Thepirlo.."pirlo:Managers:Group"..msg_chat_id) 
...
Redis:del(Thepirlo.."pirlo:Addictive:Group"..msg_chat_id) 
...
Redis:del(Thepirlo.."pirlo:Distinguished:Group"..msg_chat_id) 
...
Redis:del(Thepirlo.."pirlo:BanAll:Groups") 
...
Redis:del(Thepirlo.."pirlo:BanGroup:Group"..msg_chat_id) 
...
Redis:del(Thepirlo.."pirlo:SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(Thepirlo.."pirlo:List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(Thepirlo.."pirlo:Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(Thepirlo.."pirlo:Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(Thepirlo.."pirlo:Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(Thepirlo.."pirlo:Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(Thepirlo.."pirlo:Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(Thepirlo.."pirlo:Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(Thepirlo.."pirlo:Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(Thepirlo.."pirlo:Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(Thepirlo.."pirlo:Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(Thepirlo.."pirlo:List:Manager"..msg_chat_id)
end
...
for k,v in pairs(list) do
if Redis:get(Thepirlo.."pirlo:Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(Thepirlo.."pirlo:Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(Thepirlo.."pirlo:Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(Thepirlo.."pirlo:Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(Thepirlo.."pirlo:Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(Thepirlo.."pirlo:Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(Thepirlo.."pirlo:Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف ‹ : "
elseif Redis:get(Thepirlo.."pirlo:Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(Thepirlo.."pirlo:Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(Thepirlo.."pirlo:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(Thepirlo.."pirlo:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
local list = Redis:smembers(Thepirlo.."pirlo:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(Thepirlo.."pirlo:Add:Rd:Sudo:Gif"..v)   
Redis:del(Thepirlo.."pirlo:Add:Rd:Sudo:vico"..v)   
Redis:del(Thepirlo.."pirlo:Add:Rd:Sudo:stekr"..v)     
Redis:del(Thepirlo.."pirlo:Add:Rd:Sudo:Text"..v)   
Redis:del(Thepirlo.."pirlo:Add:Rd:Sudo:Photo"..v)
Redis:del(Thepirlo.."pirlo:Add:Rd:Sudo:Video"..v)
Redis:del(Thepirlo.."pirlo:Add:Rd:Sudo:File"..v)
Redis:del(Thepirlo.."pirlo:Add:Rd:Sudo:Audio"..v)
Redis:del(Thepirlo.."pirlo:Add:Rd:Sudo:video_note"..v)
Redis:del(Thepirlo.."pirlo:List:Rd:Sudo")
end
...
text = "\n📝︙قائمة ردود المطور \n⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n"
for k,v in pairs(list) do
if Redis:get(Thepirlo.."pirlo:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(Thepirlo.."pirlo:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(Thepirlo.."pirlo:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(Thepirlo.."pirlo:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(Thepirlo.."pirlo:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(Thepirlo.."pirlo:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(Thepirlo.."pirlo:Add:Rd:Sudo:File"..v) then
db = "ملف ‹ : "
elseif Redis:get(Thepirlo.."pirlo:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(Thepirlo.."pirlo:Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(Thepirlo.."pirlo:Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(Thepirlo.."pirlo:Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:setex(Thepirlo.."pirlo:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
‹ : ارسل لي سواء كان 
❨ ملف ‹ : ملصق ‹ : متحركه ‹ : صوره
 ‹ : فيديو ‹ : بصمه الفيديو ‹ : بصمه ‹ : صوت ‹ : رساله ❩
...
Redis:setex(Thepirlo.."pirlo:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
‹ : ارسل لي سواء كان 
❨ ملف ‹ : ملصق ‹ : متحركه ‹ : صوره
 ‹ : فيديو ‹ : بصمه الفيديو ‹ : بصمه ‹ : صوت ‹ : رساله ❩
...
Redis:setex(Thepirlo.."pirlo:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
‹ : ارسل لي سواء كان 
❨ ملف ‹ : ملصق ‹ : متحركه ‹ : صوره
 ‹ : فيديو ‹ : بصمه الفيديو ‹ : بصمه ‹ : صوت ‹ : رساله ❩
...
Redis:setex(Thepirlo.."pirlo:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(Thepirlo.."pirlo:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(Thepirlo..'pirlo:GetTexting:DevThepirlo'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(Thepirlo..'pirlo:Texting:DevThepirlo')
...
Redis:setex(Thepirlo.."pirlo:Change:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(Thepirlo.."pirlo:Name:Bot") 
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم حذف اسم البوت ","md",true)   
end
if text == (Redis:get(Thepirlo.."pirlo:Name:Bot") or "الروكس") then
local NamesBot = (Redis:get(Thepirlo.."pirlo:Name:Bot") or "الروكس")
local NameBots = {
"يروح "..NamesBot.. " كول؟",
"انا "..NamesBot.. " القميل",
"هاعمري",
...
keyboard.inline_keyboard = {
{
{text = NamesBots, url = 'https://t.me/c_p_8'}, 
},
{
...
local BotName = {
"الحمد لله ونته",
"على قول @s_l_3 ع الباري ونتَ",
"انا بخير",
}
return LuaTele.sendText(msg_chat_id,msg_id,BotName[math.random(#BotName)],"md",true)   
end
if text == "بوسه" then
local NamesBot = (Redis:get(Thepirlo.."pirlo:Name:Bot") or "pirlo")
local BotName = {
"اهممممواح🙈😉.",
"عيع خدك وصخ 😹🏃‍♀️.",
"اوفف اخدر اذاابوسه 🙈😻.",
...
"اختفوووو يلعار ابلع من عمك دراكون??🏃‍♀️.",
...
x = x + 1
Redis:srem(Thepirlo..'pirlo:Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,Thepirlo)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'*‹ : البوت عظو في المجموعه سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(Thepirlo..'pirlo:ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(Thepirlo..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(Thepirlo..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(Thepirlo..'pirlo:ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(Thepirlo.."pirlo:Game:Smile"..msg.chat_id,SM)
...
local bank_users = Redis:smembers(Thepirlo.."zrfffidtf")
...
local mony = Redis:get(Thepirlo.."zrffdcf"..v) or 0
...
if num <= 25 then
fne = Redis:get(Thepirlo..':toob:Name:'..v[2])
tt =  "["..fne.."]("..fne..")"
local mony = v[1]
local emo = emoji[k]
num = num + 1
...
ballancee = Redis:get(Thepirlo.."nool:flotysb"..msg.sender.user_id) or 0
local bank_users = Redis:smembers(Thepirlo.."ttpppi")
if #bank_users == 0 then
...
mony_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(Thepirlo.."nool:flotysb"..v) or 0
table.insert(mony_list, {tonumber(mony) , v})
end
table.sort(mony_list, function(a, b) return a[1] > b[1] end)
num = 1
...
local bank_users = Redis:smembers(Thepirlo.."almtzog"..msg_chat_id)
if #bank_users == 0 then
...
mony_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(Thepirlo.."mznom"..msg_chat_id..v) 
table.insert(mony_list, {tonumber(mony) , v})
end
table.sort(mony_list, function(a, b) return a[1] > b[1] end)
num = 1
...
for k,v in pairs(mony_list) do
if num <= 10 then
local zwga_id = Redis:get(Thepirlo..msg_chat_id..v[2].."rgalll2:")
local user_name = LuaTele.getUser(v[2]).first_name
fne = Redis:get(Thepirlo..':toob:Name:'..zwga_id)
fnte = Redis:get(Thepirlo..':toob:Name:'..v[2])
...
if tonumber(Message_Reply.sender.user_id) == tonumber(Thepirlo) then
return LuaTele.sendText(msg.chat_id,msg.id, "• غبي تبي تتزوج بوت!\n","md",true)
end
if Redis:get(Thepirlo..msg_chat_id..msg.sender.user_id.."rgalll2:") then
local zwga_id = Redis:get(Thepirlo..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local zoog2 = Redis:get(Thepirlo..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local albnt = LuaTele.getUser(zoog2)
fne = Redis:get(Thepirlo..':toob:Name:'..zoog2)
albnt = "["..fne.."](tg://user?id="..zoog2..") "
return LuaTele.sendText(msg_chat_id,msg_id,"• الحق ي : "..albnt.." زوجك يبي يتزوج ","md")
end
if Redis:get(Thepirlo..msg_chat_id..msg.sender.user_id.."bnttt2:") then
local zwga_id = Redis:get(Thepirlo..msg_chat_id..msg.sender.user_id.."bnttt2:") 
local zoog2 = Redis:get(Thepirlo..msg_chat_id..zwga_id.."rgalll2:") 
...
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
if Redis:get(Thepirlo..msg_chat_id..Message_Reply.sender.user_id.."rgalll2:") or Redis:get(Thepirlo..msg_chat_id..Message_Reply.sender.user_id.."bnttt2:") then
...
local zwga_id = Redis:get(Thepirlo..msg_chat_id..msg.sender.user_id.."bnttt2:") 
Redis:set(Thepirlo..msg_chat_id..Message_Reply.sender.user_id.."bnttt2:", msg.sender.user_id)
Redis:set(Thepirlo..msg_chat_id..msg.sender.user_id.."rgalll2:", Message_Reply.sender.user_id)
Redis:set(Thepirlo..msg_chat_id..Message_Reply.sender.user_id.."mhrrr2:", UserNameyy)
Redis:set(Thepirlo..msg_chat_id..msg.sender.user_id.."mhrrr2:", UserNameyy)
...
Redis:decrby(Thepirlo.."nool:flotysb"..msg.sender.user_id , UserNameyy)
Redis:incrby(Thepirlo.."nool:flotysb"..Message_Reply.sender.user_id , UserNameyy)
Redis:incrby(Thepirlo.."mznom"..msg_chat_id..msg.sender.user_id , UserNameyy)
Redis:sadd(Thepirlo.."almtzog"..msg_chat_id,msg.sender.user_id)
...
if text == "زواجي" then
if not Redis:get(Thepirlo..msg_chat_id..msg.sender.user_id.."rgalll2:") and not Redis:get(Thepirlo..msg_chat_id..msg.sender.user_id.."bnttt2:") then
return LuaTele.sendText(msg_chat_id,msg_id,"انت اعزب","md")
end
if Redis:get(Thepirlo..msg_chat_id..msg.sender.user_id.."bnttt2:") then
local zwga_id = Redis:get(Thepirlo..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local zoog2 = Redis:get(Thepirlo..msg_chat_id..zwga_id.."rgalll2:") 
local mhrr = Redis:get(Thepirlo..msg_chat_id..msg.sender.user_id.."mhrrr2:")
local id_rgal = LuaTele.getUser(zwga_id)
fne = Redis:get(Thepirlo..':toob:Name:'..zwga_id)
alzog = "["..fne.."](tg://user?id="..zwga_id..") "
local albnt = LuaTele.getUser(zoog2)
fnte = Redis:get(Thepirlo..':toob:Name:'..zoog2)
albnt = "["..fnte.."](tg://user?id="..zoog2..") "
return LuaTele.sendText(msg_chat_id,msg_id,"• عقد زواجكم\n• الزوج : "..alzog.."\n• الزوجه : "..albnt.." \n• المهر : "..mhrr.." دولار ","md")
end
if Redis:get(Thepirlo..msg_chat_id..msg.sender.user_id.."rgalll2:") then
local zwga_id = Redis:get(Thepirlo..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local zoog2 = Redis:get(Thepirlo..msg_chat_id..zwga_id.."bnttt2:") 
local mhrr = Redis:get(Thepirlo..msg_chat_id..msg.sender.user_id.."mhrrr2:")
local id_rgal = LuaTele.getUser(zwga_id)
fnte = Redis:get(Thepirlo..':toob:Name:'..zwga_id)
albnt = "["..fnte.."](tg://user?id="..zwga_id..") "
local gg = LuaTele.getUser(zoog2)
fntey = Redis:get(Thepirlo..':toob:Name:'..zoog2)
...
if Redis:sismember(Thepirlo.."noooybgy",yemsg.sender.user_id) then
cccc = Redis:get(Thepirlo.."noolb"..yemsg.sender.user_id)
gg = Redis:get(Thepirlo.."nnonb"..yemsg.sender.user_id)
uuuu = Redis:get(Thepirlo.."nnonbn"..yemsg.sender.user_id)
pppp = Redis:get(Thepirlo.."zrffdcf"..yemsg.sender.user_id) or 0
ballancee = Redis:get(Thepirlo.."nool:flotysb"..yemsg.sender.user_id) or 0
...
if text == "خلع" then
if not Redis:get(Thepirlo..msg_chat_id..msg.sender.user_id.."bnttt2:") then
...
alzog = " "..gg.first_name.." "
local zwga_id = Redis:get(Thepirlo..msg_chat_id..msg.sender.user_id.."bnttt2:") 
Redis:incrby(Thepirlo.."nool:flotysb"..zwga_id,mhrr)
Redis:decrby(Thepirlo.."nool:flotysb"..msg.sender.user_id,mhrr)
Redis:del(Thepirlo.."mznom"..msg_chat_id..zwga_id)
Redis:srem(Thepirlo.."almtzog"..msg_chat_id,zwga_id)
Redis:del(Thepirlo.."mznom"..msg_chat_id..msg.sender.user_id)
Redis:srem(Thepirlo.."almtzog"..msg_chat_id,msg.sender.user_id)
Redis:del(Thepirlo..msg_chat_id..msg.sender.user_id.."mhrrr2:")
Redis:del(Thepirlo..msg_chat_id..zwga_id.."mhrrr2:")
Redis:del(Thepirlo..msg_chat_id..msg.sender.user_id.."bnttt2:")
Redis:del(Thepirlo..msg_chat_id..zwga_id.."bnttt2:")
Redis:del(Thepirlo..msg_chat_id..msg.sender.user_id.."rgalll2:")
Redis:del(Thepirlo..msg_chat_id..zwga_id.."rgalll2:")
LuaTele.sendText(msg_chat_id,msg_id,"• تم خلعت زوجك "..alzog.." \n ورجعت له "..mhrr.." دولار","md")
end
if text == "طلاق"  then
if not Redis:get(Thepirlo..msg_chat_id..msg.sender.user_id.."rgalll2:") then
...
balas = 0
if Redis:sismember(Thepirlo.."noooybgy",msg.sender.user_id) then
return LuaTele.sendText(msg.chat_id,msg.id, "• لديك حساب بنكي مسبقاً\n\n• لعرض معلومات حسابك اكتب\n↤︎ `حسابي`","md",true)
end
Redis:setex(Thepirlo.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id,60, true)
...
if Redis:get(Thepirlo.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) then
...
gg = "والت كارد ."
flossst = Redis:get(Thepirlo.."nool:flotysb"..msg.sender.user_id) or 0
local banid = msg.sender.user_id
Redis:set(Thepirlo.."nonna"..msg.sender.user_id,news)
Redis:set(Thepirlo.."noolb"..msg.sender.user_id,creditcc)
Redis:set(Thepirlo.."nnonb"..msg.sender.user_id,text)
Redis:set(Thepirlo.."nnonbn"..msg.sender.user_id,gg)
Redis:set(Thepirlo.."nonallname"..creditcc,news)
Redis:set(Thepirlo.."nonallbalc"..creditcc,balas)
Redis:set(Thepirlo.."nonallcc"..creditcc,creditcc)
Redis:set(Thepirlo.."nonallban"..creditcc,text)
Redis:set(Thepirlo.."nonallid"..creditcc,banid)
Redis:sadd(Thepirlo.."noooybgy",msg.sender.user_id)
Redis:del(Thepirlo.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
...
local banid = msg.sender.user_id
Redis:set(Thepirlo.."nonna"..msg.sender.user_id,news)
Redis:set(Thepirlo.."noolb"..msg.sender.user_id,creditvi)
Redis:set(Thepirlo.."nnonb"..msg.sender.user_id,text)
Redis:set(Thepirlo.."nnonbn"..msg.sender.user_id,gg)
Redis:set(Thepirlo.."nonallname"..creditvi,news)
Redis:set(Thepirlo.."nonallbalc"..creditvi,balas)
Redis:set(Thepirlo.."nonallcc"..creditvi,creditvi)
Redis:set(Thepirlo.."nonallban"..creditvi,text)
Redis:set(Thepirlo.."nonallid"..creditvi,banid)
Redis:sadd(Thepirlo.."noooybgy",msg.sender.user_id)
Redis:del(Thepirlo.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
...
local banid = msg.sender.user_id
Redis:set(Thepirlo.."nonna"..msg.sender.user_id,news)
Redis:set(Thepirlo.."noolb"..msg.sender.user_id,creditex)
Redis:set(Thepirlo.."nnonb"..msg.sender.user_id,text)
Redis:set(Thepirlo.."nnonbn"..msg.sender.user_id,gg)
Redis:set(Thepirlo.."nonallname"..creditex,news)
Redis:set(Thepirlo.."nonallbalc"..creditex,balas)
Redis:set(Thepirlo.."nonallcc"..creditex,creditex)
Redis:set(Thepirlo.."nonallban"..creditex,text)
Redis:set(Thepirlo.."nonallid"..creditex,banid)
Redis:sadd(Thepirlo.."noooybgy",msg.sender.user_id)
Redis:del(Thepirlo.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
...
if Redis:sismember(Thepirlo.."noooybgy",msg.sender.user_id) then
Redis:srem(Thepirlo.."noooybgy", msg.sender.user_id)
Redis:del(Thepirlo.."noolb"..msg.sender.user_id)
Redis:del(Thepirlo.."zrffdcf"..msg.sender.user_id)
Redis:srem(Thepirlo.."zrfffidtf", msg.sender.user_id)
...
if msg.ControllerBot then
local bank_users = Redis:smembers(Thepirlo.."noooybgy")
for k,v in pairs(bank_users) do
Redis:del(Thepirlo.."nool:flotysb"..v)
Redis:del(Thepirlo.."zrffdcf"..v)
Redis:del(Thepirlo.."innoo"..v)
Redis:del(Thepirlo.."nnooooo"..v)
Redis:del(Thepirlo.."nnoooo"..v)
Redis:del(Thepirlo.."nnooo"..v)
Redis:del(Thepirlo.."nnoo"..v)
Redis:del(Thepirlo.."polic"..v)
Redis:del(Thepirlo.."ashmvm"..v)
Redis:del(Thepirlo.."hrame"..v)
Redis:del(Thepirlo.."test:mmtlkat6"..v)
Redis:del(Thepirlo.."zahbmm2"..v)
end
Redis:del(Thepirlo.."ttpppi")
...
ballanceed = Redis:get(Thepirlo.."nool:flotysb"..Remsg.sender.user_id) or 0
...
if Redis:sismember(Thepirlo.."noooybgy",msg.sender.user_id) then
cccc = Redis:get(Thepirlo.."noolb"..msg.sender.user_id)
gg = Redis:get(Thepirlo.."nnonb"..msg.sender.user_id)
uuuu = Redis:get(Thepirlo.."nnonbn"..msg.sender.user_id)
pppp = Redis:get(Thepirlo.."zrffdcf"..msg.sender.user_id) or 0
ballancee = Redis:get(Thepirlo.."nool:flotysb"..msg.sender.user_id) or 0
LuaTele.sendText(msg.chat_id,msg.id, "• الاسم ↢ "..news.."\n• الحساب ↢ `"..cccc.."`\n• بنك ↢ ( "..gg.." )\n• نوع ↢ ( "..uuuu.." )\n• الرصيد ↢ ( "..ballancee.." دولار 💸 )\n• الزرف ( "..pppp.." دولار ?? )\n-","md",true)
else
LuaTele.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
...
if text == 'مضاربه' then
if Redis:get(Thepirlo.."nnooooo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(Thepirlo.."nnooooo" .. msg.sender.user_id)
rr = oger(check_time)
...
Redis:decrby(Thepirlo.."nool:flotysb"..msg.sender.user_id , ballanceekku)
Redis:setex(Thepirlo.."nnooooo" .. msg.sender.user_id,1200, true)
...
ballanceekku = math.floor(coniss / 100 * modarbaa)
ballanceekkku = math.floor(ballancee + ballanceekku)
Redis:incrby(Thepirlo.."nool:flotysb"..msg.sender.user_id , math.floor(ballanceekku))
Redis:setex(Thepirlo.."nnooooo" .. msg.sender.user_id,1200, true)
...
if Redis:get(Thepirlo.."nnoooo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(Thepirlo.."nnoooo" .. msg.sender.user_id)
rr = oger(check_time)
...
if Redis:get(Thepirlo.."xxxr" .. msg.sender.user_id) then
ballanceekk = math.floor(coniss / 100 * 10)
ballanceekkk = math.floor(ballancee + ballanceekk)
Redis:incrby(Thepirlo.."nool:flotysb"..msg.sender.user_id , math.floor(ballanceekk))
Redis:sadd(Thepirlo.."ttpppi",msg.sender.user_id)
Redis:setex(Thepirlo.."nnoooo" .. msg.sender.user_id,1200, true)
...
Redis:del(Thepirlo.."nool:flotysb"..msg.sender.user_id)
...
if text == 'حظ' then
if Redis:get(Thepirlo.."nnooo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(Thepirlo.."nnooo" .. msg.sender.user_id)
rr = oger(check_time)
...
Redis:incrby(Thepirlo.."nool:flotysb"..msg.sender.user_id , math.floor(ballanceek))
Redis:setex(Thepirlo.."nnooo" .. msg.sender.user_id,200, true)
...
ff = Redis:get(Thepirlo.."nool:flotysb"..msg.sender.user_id)
...
Redis:decrby(Thepirlo.."nool:flotysb"..msg.sender.user_id , coniss)
Redis:setex(Thepirlo.."nnooo" .. msg.sender.user_id,200, true)
ff = Redis:get(Thepirlo.."nool:flotysb"..msg.sender.user_id) or 0
...
Redis:set('Thepirlo:'..bot_id..'idgem:user'..msg.chat_id_,taha)  
Redis:setex('Thepirlo:'..bot_id.."gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
Redis:incrby('Thepirlo:'..bot_id..'add:F'..msg.chat_id_..result.sender_user_id_,F)  
Redis:incrby('Thepirlo:'..bot_id..'add:Fall'..msg.chat_id_..result.sender_user_id_,F)  
...
local coniss = coniss:gsub('٩','9')
local coniss = tonumber(coniss)
if not Redis:sismember(Thepirlo.."noooybgy",msg.sender.user_id) then
return LuaTele.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ","md",true)
end
if Redis:get(Thepirlo.."polici" .. msg.sender.user_id) then  
local check_time = Redis:ttl(Thepirlo.."polici" .. msg.sender.user_id)
rr = oger(check_time)
...
Redis:set(Thepirlo.."transn"..msg.sender.user_id,coniss)
Redis:setex(Thepirlo.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id,60, true)
LuaTele.sendText(msg.chat_id,msg.id,[[
...
if Redis:get(Thepirlo.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id) then
cccc = Redis:get(Thepirlo.."noolb"..msg.sender.user_id)
gg = Redis:get(Thepirlo.."nnonb"..msg.sender.user_id)
uuuu = Redis:get(Thepirlo.."nnonbn"..msg.sender.user_id)
if text ~= text:match('^(%d+)$') then
Redis:del(Thepirlo.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id) 
Redis:del(Thepirlo.."transn" .. msg.sender.user_id)
...
if Redis:get(Thepirlo.."nonallcc"..text) then
local UserNamey = Redis:get(Thepirlo.."transn"..msg.sender.user_id)
local ban = LuaTele.getUser(msg.sender.user_id)
if ban.first_name then
...
local fsvhhh = Redis:get(Thepirlo.."nonallid"..text)
local bann = LuaTele.getUser(fsvhhh)
hsabe = Redis:get(Thepirlo.."nnonb"..fsvhhh)
nouu = Redis:get(Thepirlo.."nnonbn"..fsvhhh)
...
if Redis:get(Thepirlo.."hramep" .. UserNameyr) then  
local check_time = Redis:ttl(Thepirlo.."hramep" .. UserNameyr)
rr = oger(check_time)
...
Redis:incrby(Thepirlo.."nool:flotysb"..fsvhhh ,UserNameyy)
Redis:decrby(Thepirlo.."nool:flotysb"..msg.sender.user_id ,UserNamey)
Redis:setex(Thepirlo.."polici" .. msg.sender.user_id,600, true)
Redis:setex(Thepirlo.."hramep" ..UserNamey ,600, true)
...
ballancee = Redis:get(Thepirlo.."nool:flotysb"..bl) or 0
Redis:decrby(Thepirlo.."nool:flotysb"..bl , ballancee)
LuaTele.sendText(msg.chat_id,msg.id, "*تم تصفيرة بنجاح !*","md",true)
end

if text == 'قرض' or text == 'قرض' then
if Redis:sismember(Thepirlo.."noooybgy",msg.sender.user_id) then
if Redis:get(Thepirlo.."nnoo1" .. msg.sender.user_id) then  
local check_time = Redis:ttl(Thepirlo.."nnoo1" .. msg.sender.user_id)
rr = oger(check_time)
return LuaTele.sendText(msg.chat_id, msg.id,"• من شوي عطيتك انتظر "..rr.." دقيقة") 
end
if Redis:get(Thepirlo.."xxxr" .. msg.sender.user_id) then
Redis:incrby(Thepirlo.."nool:flotysb"..msg.sender.user_id , 1000000)
Redis:sadd(Thepirlo.."ttpppi",msg.sender.user_id)
return LuaTele.sendText(msg.chat_id,msg.id,"• خذ قرض 1000000 دولار 💸","md",true)
end
local jjjo = "6000000"
Redis:incrby(Thepirlo.."nool:flotysb"..msg.sender.user_id , jjjo)
Redis:sadd(Thepirlo.."ttpppi",msg.sender.user_id)
LuaTele.sendText(msg.chat_id,msg.id,"• خذ ي مطفر "..jjjo.." دولار 💸","md",true)
Redis:setex(Thepirlo.."nnoo1" .. msg.sender.user_id,600, true)
else
LuaTele.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
if Redis:sismember(Thepirlo.."noooybgy",msg.sender.user_id) then
if Redis:get(Thepirlo.."nnoo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(Thepirlo.."nnoo" .. msg.sender.user_id)
rr = oger(check_time)
return LuaTele.sendText(msg.chat_id, msg.id,"• من شوي عطيتك انتظر "..rr.." دقيقة") 
end
if Redis:get(Thepirlo.."xxxr" .. msg.sender.user_id) then
Redis:incrby(Thepirlo.."nool:flotysb"..msg.sender.user_id , 3000)
Redis:sadd(Thepirlo.."ttpppi",msg.sender.user_id)
...
Redis:sadd(Thepirlo.."ttpppi",msg.sender.user_id)
LuaTele.sendText(msg.chat_id,msg.id,"• خذ ي مطفر "..jjjo.." دولار 💸","md",true)
Redis:setex(Thepirlo.."nnoo" .. msg.sender.user_id,600, true)
else
LuaTele.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
if Redis:sismember(Thepirlo.."noooybgy",UserId_Info.id) then
ballanceed = Redis:get(Thepirlo.."nool:flotysb"..UserId_Info.id) or 0
LuaTele.sendText(msg.chat_id,msg.id, "• فلوسه "..ballanceed.." دولار 💸","md",true)
else
...
if Redis:get(Thepirlo.."polic" .. msg.sender.user_id) then  
local check_time = Redis:ttl(Thepirlo.."polic" .. msg.sender.user_id)
rr = oger(check_time)
...
if Redis:get(Thepirlo.."hrame" .. Remsg.sender.user_id) then  
local check_time = Redis:ttl(Thepirlo.."hrame" .. Remsg.sender.user_id)
rr = oger(check_time)
return LuaTele.sendText(msg.chat_id, msg.id,"• زارفينه قبلك \n• يمديك تزرفه بعد "..rr.." دقيقة") 
end 
if Redis:sismember(Thepirlo.."noooybgy",Remsg.sender.user_id) then
ballanceed = Redis:get(Thepirlo.."nool:flotysb"..Remsg.sender.user_id) or 0
...
local ballanceed = Redis:get(Thepirlo.."nool:flotysb"..Remsg.sender.user_id) or 0
Redis:incrby(Thepirlo.."nool:flotysb"..msg.sender.user_id , hrame)
Redis:decrby(Thepirlo.."nool:flotysb"..Remsg.sender.user_id , hrame)
Redis:sadd(Thepirlo.."ttpppi",msg.sender.user_id)
Redis:setex(Thepirlo.."hrame" .. Remsg.sender.user_id,900, true)
Redis:incrby(Thepirlo.."zrffdcf"..msg.sender.user_id,hrame)
Redis:sadd(Thepirlo.."zrfffidtf",msg.sender.user_id)
Redis:setex(Thepirlo.."polic" .. msg.sender.user_id,300, true)
...
Redis:incrby(Thepirlo.."nool:flotysb"..msg.sender.user_id , F)
local ballancee = Redis:get(Thepirlo.."nool:flotysb"..msg.sender.user_id) or 0
...
Redis:setex(Thepirlo.."innoo" .. msg.sender.user_id,600, true)
end
if text == 'راتب' or text == 'راتبي' then
if Redis:sismember(Thepirlo.."noooybgy",msg.sender.user_id) then
if Redis:get(Thepirlo.."innoo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(Thepirlo.."innoo" .. msg.sender.user_id)
rr = oger(check_time)
...
Redis:set(Thepirlo.."pirlo:Game:Monotonous"..msg.chat_id,name)
...
name = KlamSpeed[math.random(#KlamSpeed)]
Redis:set(Thepirlo.."mshaher"..msg.chat_id,name)
...
Redis:set(Thepirlo.."pirlo:Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(Thepirlo.."pirlo:Status:Games"..msg.chat_id) then
Redis:del(Thepirlo.."pirlo:Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(Thepirlo.."pirlo:Game:Meaningof"..msg.chat_id,name)
...
if Redis:get(Thepirlo.."pirlo:Status:Games"..msg.chat_id) then
Redis:del(Thepirlo.."Set:Country"..msg.chat_id)
...
Redis:set(Thepirlo.."Game:Countrygof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(Thepirlo.."pirlo:Status:Games"..msg.chat_id) then
Redis:del(Thepirlo.."pirlo:Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(Thepirlo.."pirlo:Game:Reflection"..msg.chat_id,name)
...
Redis:set(Thepirlo.."pirlo:Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(Thepirlo.."pirlo:Game:Difference"..msg.chat_id,name)
...
Redis:set(Thepirlo.."pirlo:Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(Thepirlo.."pirlo:Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(Thepirlo.."pirlo:Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(Thepirlo.."pirlo:Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(Thepirlo.."pirlo:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(Thepirlo.."pirlo:Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(Thepirlo.."pirlo:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(Thepirlo.."pirlo:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(Thepirlo.."pirlo:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(Thepirlo.."pirlo:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(Thepirlo.."pirlo:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(Thepirlo.."pirlo:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(Thepirlo.."pirlo:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(Thepirlo.."pirlo:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(Thepirlo.."pirlo:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(Thepirlo.."pirlo:Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(Thepirlo.."pirlo:Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(Thepirlo.."pirlo:Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(Thepirlo.."pirlo:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','ردود المدير')
Redis:set(Thepirlo.."pirlo:Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(Thepirlo.."pirlo:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(Thepirlo.."pirlo:Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(Thepirlo.."pirlo:Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(Thepirlo.."pirlo:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(Thepirlo.."pirlo:Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
...
Redis:sadd(Thepirlo..'pirlo:Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(Thepirlo.."pirlo:Start:Bot") then
local CmdStart = '*\n‹ : اهلا بك عزيزي في بوت '..(Redis:get(Thepirlo.."pirlo:Name:Bot") or "pirlo")..
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(Thepirlo.."pirlo:Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
Redis:setex(Thepirlo.."pirlo:Change:Start:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(Thepirlo.."pirlo:Start:Bot") 
...
LuaTele.sendText(msg_chat_id,msg_id,'*‹ : عدد احصائيات البوت الكامله \n⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n‹ : عدد المجموعات : '..(Redis:scard(Thepirlo..'pirlo:ChekBotAdd') or 0)..'\n‹ : عدد المشتركين : '..(Redis:scard(Thepirlo..'pirlo:Num:User:Pv') or 0)..'*',"md",true)  
end
if text == 'الرتبه' or text == 'رتبته'  and msg.reply_to_message_id ~= 0 then
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
local UserInfo = LuaTele.getUser(Message_Reply.sender.user_id)
...
if not msg.ControllerBot then
if Redis:get(Thepirlo.."pirlo:TwaslBot") and not Redis:sismember(Thepirlo.."pirlo:BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(Thepirlo.."pirlo:Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(Thepirlo.."pirlo:Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(Thepirlo..'pirlo:BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'‹ : تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(Thepirlo..'pirlo:BaN:In:Tuasl',Info_User)  
...
Redis:srem(Thepirlo.."pirlo:ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(Thepirlo..'*'..'-100'..data.supergroup.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(Thepirlo.."pirlo:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Thepirlo.."pirlo:PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(Thepirlo.."pirlo:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Thepirlo.."pirlo:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(Thepirlo.."pirlo:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Thepirlo.."pirlo:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(Thepirlo.."pirlo:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Thepirlo.."pirlo:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(Thepirlo.."pirlo:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Thepirlo.."pirlo:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(Thepirlo.."pirlo:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Thepirlo.."pirlo:PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(Thepirlo.."pirlo:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Thepirlo.."pirlo:PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(Thepirlo.."pirlo:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Thepirlo.."pirlo:PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(Thepirlo.."pirlo:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Thepirlo.."pirlo:PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(Thepirlo.."pirlo:Lock:tagservr"..data.message.chat_id) then
LuaTele.deleteMessages(data.message.chat_id,{[1]= data.message.id})
end
end 
if tonumber(data.message.sender.user_id) == tonumber(Thepirlo) then
return false
end
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(Thepirlo..'pirlo:Status:joinet'..data.message.chat_id) == 'true' then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if Message_Edit.sender.user_id == Thepirlo then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(Thepirlo..'pirlo:Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(Thepirlo.."pirlo:Lock:edit"..data.chat_id) then
...
local Get_Chat = LuaTele.getChat(ChatId)
local GetLink = Redis:get(Thepirlo.."pirlo:Group:Link"..ChatId) 
if GetLink then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
{
...
io.popen("curl -s 'http://185.185.127.158/pirlo/yt2.php?url="..listYt[2].."&token="..Token.."&chat="..ChatId.."&type=ogg&msg=0'")
end
end
...
if tonumber(listYt[1]) == tonumber(IdUser) then
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
io.popen("curl -s 'http://185.185.127.158/pirlo/yt2.php?url="..listYt[2].."&token="..Token.."&chat="..ChatId.."&type=mp3&msg=0'")
end
end
...
if tonumber(listYt[1]) == tonumber(IdUser) then
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
io.popen("curl -s 'http://185.185.127.158/pirlo/yt2.php?url="..listYt[2].."&token="..Token.."&chat="..ChatId.."&type=mp4&msg=0'")
end
end
...
{
{text = '❲ ‹   ‹ ︙𝔇ℜ𝔞𝔤𝔬𝔫 𝔱𝔢𝔞𝔪 . 𝖲𝗈𝗎𝗋𝖼𝖾 ❳',url="t.me/c_p_8"}
},
}
local msg_id = Msg_id/2097152/0.5
...
Redis:set(Thepirlo.."pirlo:Get:Reides:Commands:Group"..UserId[2]..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(Thepirlo.."pirlo:Get:Reides:Commands:Group"..UserId[2]..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(Thepirlo.."pirlo:Get:Reides:Commands:Group"..UserId[2]..":"..'ا','ايدي')
Redis:set(Thepirlo.."pirlo:Get:Reides:Commands:Group"..UserId[2]..":"..'م','رفع مميز')
Redis:set(Thepirlo.."pirlo:Get:Reides:Commands:Group"..UserId[2]..":"..'اد', 'رفع ادمن')
Redis:set(Thepirlo.."pirlo:Get:Reides:Commands:Group"..UserId[2]..":"..'مد','رفع مدير')
Redis:set(Thepirlo.."pirlo:Get:Reides:Commands:Group"..UserId[2]..":"..'من', 'رفع منشئ')
Redis:set(Thepirlo.."pirlo:Get:Reides:Commands:Group"..UserId[2]..":"..'اس', 'رفع منشئ اساسي')
Redis:set(Thepirlo.."pirlo:Get:Reides:Commands:Group"..UserId[2]..":"..'مط','رفع مطور')
Redis:set(Thepirlo.."pirlo:Get:Reides:Commands:Group"..UserId[2]..":"..'تك','تنزيل الكل')
Redis:set(Thepirlo.."pirlo:Get:Reides:Commands:Group"..UserId[2]..":"..'ر','الرابط')
Redis:set(Thepirlo.."pirlo:Get:Reides:Commands:Group"..UserId[2]..":"..'رر','ردود المدير')
Redis:set(Thepirlo.."pirlo:Get:Reides:Commands:Group"..UserId[2]..":"..'،،','مسح المكتومين')
Redis:set(Thepirlo.."pirlo:Get:Reides:Commands:Group"..UserId[2]..":"..'رد','اضف رد')
Redis:set(Thepirlo.."pirlo:Get:Reides:Commands:Group"..UserId[2]..":"..'سح','مسح سحكاتي')
Redis:set(Thepirlo.."pirlo:Get:Reides:Commands:Group"..UserId[2]..":"..'غ','غنيلي')
Redis:set(Thepirlo.."pirlo:Get:Reides:Commands:Group"..UserId[2]..":"..'رس','رسائلي')
Redis:set(Thepirlo.."pirlo:Get:Reides:Commands:Group"..UserId[2]..":"..'ثانوي','رفع مطور ثانوي')
...
if tonumber(listYt[1]) == tonumber(IdUser) then
Redis:srem(Thepirlo.."pirlo:SilentGroup:Group"..ChatId,listYt[2]) 
Redis:srem(Thepirlo.."pirlo:BanGroup:Group"..ChatId,listYt[2]) 
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:del(Thepirlo.."pirlo:Redis:Id:Group"..ChatId..""..IdUser) 
Redis:del(Thepirlo.."pirlo1:Set:Rd"..IdUser..":"..ChatId)
Redis:del(Thepirlo.."pirlo:Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(Thepirlo.."pirlo:Set:Rd"..IdUser..":"..ChatId)
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(Thepirlo.."pirlo:Redis:Id:Group"..ChatId..""..IdUser,true) 
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(Thepirlo.."pirlo1:Set:Rd"..IdUser..":"..ChatId, "true")
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(Thepirlo.."pirlo:Set:Manager:rd"..IdUser..":"..ChatId,"true")
LuaTele.editMessageText(ChatId,Msg_id,"‹ : ارسل لي الرد الان", 'md', true)
end
end
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(Thepirlo.."pirlo:Set:Rd"..IdUser..":"..ChatId,true)
LuaTele.editMessageText(ChatId,Msg_id,"‹ : ارسل لي الرد الان", 'md', true)
end
end
...
Redis:incrby(Thepirlo.."pirlo:Num:Add:Games"..ChatId..IdUser, 1)  
...
local TextHelp = [[*
‹ : أهلا بك في قائمة العاب سورس    ‹ ︙𝔇ℜ𝔞𝔤𝔬𝔫 𝔱𝔢𝔞𝔪 .اختر نوع الالعاب 
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
local TextHelp = [[*
‹ : مرحبا بك في الالعاب المتطورة الخاص بسورس    ‹ ︙𝔇ℜ𝔞𝔤𝔬𝔫 𝔱𝔢𝔞𝔪 .
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Thepirlo.."pirlo:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Thepirlo.."pirlo:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Thepirlo.."pirlo:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Thepirlo.."pirlo:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Thepirlo.."pirlo:Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(Thepirlo.."pirlo:TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(Thepirlo.."pirlo:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(Thepirlo.."pirlo:Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(Thepirlo..'pirlo:'..lock..UserId[2],"del")    
end
...
local bank_users = Redis:smembers(Thepirlo.."almtzog"..ChatId)
top_mony = "توب اغنى 10 زوجات بالقروب :\n\n"
mony_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(Thepirlo.."mznom"..ChatId..v)
table.insert(mony_list, {tonumber(mony) , v})
end
table.sort(mony_list, function(a, b) return a[1] > b[1] end)
num = 1
...
for k,v in pairs(mony_list) do
if num <= 10 then
local zwga_id = Redis:get(Thepirlo..ChatId..v[2].."rgalll2:")
local user_name = LuaTele.getUser(v[2]).first_name
local user_nambe = LuaTele.getUser(zwga_id).first_name
...
ballancee = Redis:get(Thepirlo.."zrffdcf"..IdUser) or 0
local bank_users = Redis:smembers(Thepirlo.."zrfffidtf")
top_mony = "توب اكثر 25 شخص حرامية فلوس:\n\n"
mony_list = {}
for k,v in pairs(bank_users) do
...
ballancee = Redis:get(Thepirlo.."nool:flotysb"..IdUser) or 0
local bank_users = Redis:smembers(Thepirlo.."ttpppi")
top_mony = "توب اغنى 25 شخص :\n\n"
mony_list = {}
for k,v in pairs(bank_users) do
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(Thepirlo.."pirlo:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."wtka:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."klb:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."mar:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."smb:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."kholat:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."8by:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."3ra:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:BanGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"‹ : تم مسح المحظورين", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Thepirlo.."pirlo:SilentGroup:Group"..ChatId) 
