...
Status = Redis:get(TheSnap.."Snap:Developer:Bot:Reply"..ChatId) or 'المطور الثانوي'
...
if text and Redis:get(TheSnap..'lock:Fshar'..msg.chat_id) and not msg.Special then 
...
if text and Redis:get(TheSnap..'lock:Fars'..msg.chat_id) and not msg.Special then 
...
Redis:incr(TheSnap.."Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(TheSnap.."Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(TheSnap.."Lock:Bot:kick"..msg_chat_id)
for k,v in pairs(msg.content.member_user_ids) do
local Info_User = LuaTele.getUser(v) 
print(v)
if v == tonumber(TheSnap) then
local N = (Redis:get(TheSnap.."Name:Bot") or "سناب")
...
Redis:set(TheSnap.."Who:Added:Me"..msg_chat_id..":"..v,msg.sender.user_id)
...
Redis:incr(TheSnap.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
if Redis:get(TheSnap.."Game:Countrygof"..msg.chat_id) then
if text == Redis:get(TheSnap.."Game:Countrygof"..msg.chat_id) then
Redis:incrby(TheSnap.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheSnap.."Game:Countrygof"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔ : لقد فزت في اللعبه \n⌔ : العب مره اخره وارسل - اعلام","md",true)  
end
end
if Redis:get(TheSnap.."mshaher"..msg.chat_id) then
if text == Redis:get(TheSnap.."mshaher"..msg.chat_id) then
Redis:del(TheSnap.."mshaher"..msg.chat_id)
Redis:incrby(TheSnap.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔ : لقد فزت في اللعبه \n⌔ : العب مره اخره وارسل - بوب او مشاهير","md",true)  
end
end
if Redis:get(TheSnap.."Game:enkliz"..msg.chat_id) then
if text == Redis:get(TheSnap.."Game:enkliz"..msg.chat_id) then
Redis:incrby(TheSnap.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheSnap.."Game:enkliz"..msg.chat_id)
...
Redis:set(TheSnap..'Snap:Channel:Join:Name',UserId_Info.title) 
...
--download('https://raw.githubusercontent.com/SourceTheSnap/TheSnap/master/Snap.lua','Snap.lua')
...
local UserInfo = LuaTele.getUser(TheSnap)
for Name_User in string.gmatch(UserInfo.first_name, "[^%s]+" ) do
UserInfo.first_name = Name_User
break
end 
NamesBot = (Redis:get(TheSnap.."Snap:Name:Bot") or "سناب")
Groups = (Redis:scard(TheSnap..'Snap:ChekBotAdd') or 0)
Users = (Redis:scard(TheSnap..'Snap:Num:User:Pv') or 0)
...
local NumAdd = Redis:get(TheSnap.."Snap:Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(TheSnap.."Snap:Num:Add:Games"..msg.chat_id..UserId) or 0
if Get_Is_Id then
...
Redis:sadd(TheSnap.."Snap:TheBasics:Group"..msg_chat_id,msg.sender.user_id) 
...
Redis:del(TheSnap..'Abs:gif:Abs'..msg.chat_id) 
end
...
local F333F = ' \n⌔ : تم تعطيل المتحركه'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(TheSnap..'Abs:gif:Abs'..msg.chat_id,true)  
end
if text and (text == "متحركه" or text == "↫ متحركه ✯") and not Redis:get(TheSnap..'Abs:gif:Abs'..msg.chat_id) then
...
local F333F = ' \n⌔ : تم تفعيل الميمز'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(TheSnap..'Abs:memz:Abs'..msg.chat_id) 
end
...
local F333F = ' \n⌔ : تم تعطيل الميمز'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(TheSnap..'Abs:memz:Abs'..msg.chat_id,true)  
end
if text and (text == "ميمز" or text == "↫ ميمز ✯") and not Redis:get(TheSnap..'Abs:memz:Abs'..msg.chat_id) then
...
local F333F = ' \n⌔ : تم تفعيل الريمكس'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(TheSnap..'Abs:Remix:Abs'..msg.chat_id) 
end
...
local F333F = ' \n⌔ : تم تعطيل الريمكس'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(TheSnap..'Abs:Remix:Abs'..msg.chat_id,true)  
end
...
local F333F = ' \n⌔ : تم تفعيل الصوره'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(TheSnap..'Abs:Photo:Abs'..msg.chat_id) 
end
...
local F333F = ' \n⌔ : تم تعطيل الصوره'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(TheSnap..'Abs:Photo:Abs'..msg.chat_id,true)  
end
if text and (text == "صوره" or text == "↫ صوره ✯") and not Redis:get(TheSnap..'Abs:Photo:Abs'..msg.chat_id) then
...
local F333F = ' \n⌔ : تم تفعيل الانمي'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(TheSnap..'Abs:Anime:Abs'..msg.chat_id) 
end
...
local F333F = ' \n⌔ : تم تعطيل الانمي'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(TheSnap..'Abs:Anime:Abs'..msg.chat_id,true)  
end
if text and (text == "انمي" or text == "↫ انمي ✯") and not Redis:get(TheSnap..'Abs:Anime:Abs'..msg.chat_id) then
...
local F333F = ' \n⌔ : تم تفعيل الافلام'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(TheSnap..'Abs:Movies:Abs'..msg.chat_id) 
end
...
local F333F = ' \n⌔ : تم تعطيل الافلام'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(TheSnap..'Abs:Movies:Abs'..msg.chat_id,true)  
end
if text and (text == "فلم" or text == "↫ فلم ✯") and not Redis:get(TheSnap..'Abs:Movies:Abs'..msg.chat_id) then
...
local F333F = ' \n⌔ : تم تفعيل المسلسلات'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(TheSnap..'Abs:Series:Abs'..msg.chat_id) 
end
...
local F333F = ' \n⌔ : تم تعطيل المسلسلات'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(TheSnap..'Abs:Series:Abs'..msg.chat_id,true)  
end
if text and (text == "مسلسل" or text == "↫ مسلسل ✯") and not Redis:get(TheSnap..'Abs:Series:Abs'..msg.chat_id) then
...
if text == 'بايو' and not Redis:get(TheSnap..'idnotmembio'..msg.chat_id)  then
...
if Redis:get(TheSnap..'idnotmembio'..msg.chat_id)  then
LuaTele.sendText(msg_chat_id,msg_id, '⌔ : تم تعطيل امر البايو مسبقا\n ✓',"md")
else
Redis:set(TheSnap.."idnotmembio"..msg.chat_id,"true")
...
if not Redis:get(TheSnap..'idnotmembio'..msg.chat_id)  then
LuaTele.sendText(msg_chat_id,msg_id, '⌔ : تم تفعيل امر البايو مسبقا\n ✓',"md")
else
Redis:del(TheSnap.."idnotmembio"..msg.chat_id)
...
if Redis:get(TheSnap..":"..msg.sender.user_id..":lov_Bots"..msg.chat_id) == "sendlove" then
...
Redis:del(TheSnap..":"..msg.sender.user_id..":lov_Bots"..msg.chat_id)
end
if Redis:get(TheSnap..":"..msg.sender.user_id..":lov_Bottts"..msg.chat_id) == "sendlove" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '⌔ : اليك النتائج الخـاصة :\n\n⌔ : نسبة الغباء  : *'..text..'* '..sendnum..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(TheSnap..":"..msg.sender.user_id..":lov_Bottts"..msg.chat_id)
end
if Redis:get(TheSnap..":"..msg.sender.user_id..":lov_Botttuus"..msg.chat_id) == "sendlove" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '⌔ : اليك النتائج الخـاصة :\n\n⌔ : نسبة الذكاء  : *'..text..'* '..sendnum..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(TheSnap..":"..msg.sender.user_id..":lov_Botttuus"..msg.chat_id)
end
if text and Redis:get(TheSnap..":"..msg.sender.user_id..":krh_Bots"..msg.chat_id) == "sendkrhe" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '⌯ اليك النتائج الخـاصة :\n\n⌯ نسبه الكرة : *'..text..'* '..sendnum..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(TheSnap..":"..msg.sender.user_id..":krh_Bots"..msg.chat_id)
end
if text and text ~="نسبه الرجوله" and Redis:get(TheSnap..":"..msg.sender.user_id..":rjo_Bots"..msg.chat_id) == "sendrjoe" then
numj = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","🥰 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnuj = numj[math.random(#numj)]
local tttttt = '⌔ : اليك النتائج الخـاصة :\n\n⌔ :  نسبة الرجوله لـ : *'..text..'* '..sendnuj..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(TheSnap..":"..msg.sender.user_id..":rjo_Bots"..msg.chat_id)
end
if text and text ~="نسبه الانوثه" and Redis:get(TheSnap..":"..msg.sender.user_id..":ano_Bots"..msg.chat_id) == "sendanoe" then
numj = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","?? 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnuj = numj[math.random(#numj)]
local tttttt = '⌔ : اليك النتائج الخـاصة :\n\n⌔ :  نسبه الانوثة لـ : *'..text..'* '..sendnuj..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(TheSnap..":"..msg.sender.user_id..":ano_Bots"..msg.chat_id)
end

if text == "نسبه الحب" or text == "نسبه حب" and msg.reply_to_message_id ~= 0 then
if not Redis:get(TheSnap.."AlNsb"..msg.chat_id) then    
Redis:set(TheSnap..":"..msg.sender.user_id..":lov_Bots"..msg.chat_id,"sendlove")
...
if not Redis:get(TheSnap.."AlNsb"..msg.chat_id) then    
Redis:set(TheSnap..":"..msg.sender.user_id..":lov_Bottts"..msg.chat_id,"sendlove")
...
if not Redis:get(TheSnap.."AlNsb"..msg.chat_id) then    
Redis:set(TheSnap..":"..msg.sender.user_id..":lov_Botttuus"..msg.chat_id,"sendlove")
hggg = '⌔ : الان ارسل اسم الشخص :'
LuaTele.sendText(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(TheSnap.."AlNsb"..msg.chat_id) then    
Redis:set(TheSnap..":"..msg.sender.user_id..":krh_Bots"..msg.chat_id,"sendkrhe")
hggg = '⌔ : الان ارسل اسمك واسم الشخص الثاني :'
LuaTele.sendText(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(TheSnap.."AlNsb"..msg.chat_id) then    
Redis:set(TheSnap..":"..msg.sender.user_id..":rjo_Bots"..msg.chat_id,"sendrjoe")
hggg = '⌔ : الان ارسل اسم الشخص :'
LuaTele.sendText(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(TheSnap.."AlNsb"..msg.chat_id) then    
Redis:set(TheSnap..":"..msg.sender.user_id..":ano_Bots"..msg.chat_id,"sendanoe")
hggg = '⌔ : الان ارسل اسم الشخص :'
LuaTele.sendText(msg_chat_id,msg_id,hggg) 
return false
end
...
if Redis:get(TheSnap..'AlNsb'..msg.chat_id)  then
return LuaTele.sendText(msg_chat_id,msg_id,'⌔ : تم تعطيل النسب مسبقا\n ✓',"md")
else
Redis:set(TheSnap.."AlNsb"..msg.chat_id,"true")
...
Redis:del(TheSnap.."AlNsb"..msg.chat_id)
...
if Redis:get(TheSnap..'myphoto'..msg.chat_id)  then
return LuaTele.sendText(msg_chat_id,msg_id,'⌔ : تم تعطيل صورتي مسبقا\n ✓',"md")
else
Redis:set(TheSnap.."myphoto"..msg.chat_id,"off")
...
if not Redis:get(TheSnap..'myphoto'..msg.chat_id)  then
return LuaTele.sendText(msg_chat_id,msg_id,'⌔ : تم تفعيل صورتي مسبقا\n ✓',"md")
else
Redis:del(TheSnap.."myphoto"..msg.chat_id)
...
Redis:del(TheSnap.."mybuti"..msg_chat_id)
...
Redis:set(TheSnap.."mybuti"..msg_chat_id,"off")
...
Redis:del(TheSnap.."sayy"..msg_chat_id)
...
Redis:set(TheSnap.."sayy"..msg_chat_id,"off")
LuaTele.sendText(msg_chat_id,msg_id,'\n*⌔ : تم امر امر كول * ',"md",true)  
end
if text == "جمالي" or text == 'نسبه جمالي' then
if Redis:get(TheSnap.."mybuti"..msg_chat_id) == "off" then
...
if Redis:get(TheSnap.."sayy"..msg_chat_id) == "off" then
...
if text == "صورتي" then
if Redis:get(TheSnap.."myphoto"..msg_chat_id) == "off" then
...
if not Redis:sismember(TheSnap.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheSnap.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheSnap.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔ : الحمار هاذا بطل يصفن ").Reply,"md",true)  
else
Redis:srem(TheSnap.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "قرد" then
if not Redis:sismember(TheSnap.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheSnap.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheSnap.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheSnap.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "ملك" then
if not Redis:sismember(TheSnap.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheSnap.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheSnap.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheSnap.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheSnap.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔ : يارب تعقل وتبقا ذكي 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(TheSnap.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheSnap.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔ : اعقل بقا 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(TheSnap.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
Redis:srem(TheSnap.."Snap:TheBasicsW:Group"..msg_chat_id,UserId[2]) 
...
if TextMsg == "كانسر" then
if ChannelJoin(msg) == false then
local chinfo = Redis:get(TheSnap.."ch:admin")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ''..Redis:get(TheSnap..'Snap:Channel:Join:Name')..'', url = 't.me/'..Redis:get(TheSnap..'Snap:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n⌔ : عمࢪي اشتࢪك ثم استخدم الامࢪ❗️*',"md",false, false, false, false, reply_markup)
end
if Redis:sismember(TheSnap.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheSnap.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheSnap.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheSnap.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheSnap.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheSnap.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheSnap.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheSnap.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheSnap.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheSnap.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheSnap.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheSnap.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheSnap.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheSnap.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheSnap.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheSnap.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
local Info_Members = Redis:smembers(TheSnap.."wtka:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheSnap.."mar:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheSnap.."2rd:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheSnap.."klb:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheSnap.."smb:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheSnap.."kholat:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheSnap.."8by:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheSnap.."3ra:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
if Redis:get(TheSnap.."zhrfa"..msg.sender.user_id) == "sendzh" then
...
local httpsCurl = "http://185.185.127.158/snap/tahaj200.php?token="..Token.."&msg="..MsgId.."&Text="..URL.escape(Ttext).."&chat_id="..msg.chat_id.."&user="..msg.sender.user_id
...
{{text = 'Delete Instagram',url="https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/"},{text = 'Delete Snapchat',url="https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount"}},{{text= '❲ 𝘴????𝘱 𝖲𝗈𝗎𝗋𝖼𝖾 ❳',url="t.me/iinzzz"}}
}
local msg_id = msg.id/2097152/0.5
...
if text == "زواج" or text == "رفع زوجتي" or text == "رفع زوجي" and msg.reply_to_message_id ~= 0 then
  ...
  if tonumber(Message_Reply.sender.user_id) == tonumber(TheSnap) then
    return LuaTele.sendText(msg_chat_id,msg_id,"ابعد عني يحيحان ملكقتش غيري","md",true)  
  end
  if Redis:sismember(TheSnap..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
    local rd_mtzwga = {
    ...
    if Redis:sismember(TheSnap..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) then 
    Redis:srem(TheSnap..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id)
    end
    Redis:sadd(TheSnap..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) 
...
if text == "تاك للزوجات" or text == "الزوجات" then
  local zwgat_list = Redis:smembers(TheSnap..msg_chat_id.."zwgat:")
...
if text == "طلاق" or text == "تنزيل زوجتي" or text == "تزيل زوجي" and msg.reply_to_message_id ~= 0 then
  ...
  if Redis:sismember(TheSnap..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
    Redis:srem(TheSnap..msg_chat_id.."zwgat:",Message_Reply.sender.user_id)
    Redis:sadd(TheSnap..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) 
    local rd_tmtlaq = {
      "تم طلاقكم للاسف",
...
if text == "تاك للمطلقات" or text == "المطلقات" then
  local mutlqat_list = Redis:smembers(TheSnap..msg_chat_id.."mutlqat:")
...
Redis:del(TheSnap.."Snap:Status:joinet"..msg_chat_id) 
...
Redis:set(TheSnap.."Snap:Status:joinet"..msg_chat_id,true) 
...
Redis:set(TheSnap.."lockalllll"..msg_chat_id,"off")
...
Redis:set(TheSnap.."lockalllll"..msg_chat_id,"on")
...
Redis:set(TheSnap.."Snap:Lock:phshar"..msg_chat_id,true) 
...
Redis:set(TheSnap..'lock:Fars'..msg.chat_id,true) 
...
Redis:del(TheSnap.."Snap:Lock:phshar"..msg_chat_id)  
...
Redis:del(TheSnap..'lock:Fars'..msg.chat_id) 
...
if text == (Redis:get(TheSnap.."Snap:Name:Bot") or "آيلاند") then
local photo = LuaTele.getUserProfilePhotos(TheSnap)
local UserInfo = LuaTele.getUser(TheSnap)
for Name_User in string.gmatch(UserInfo.first_name, "[^%s]+" ) do
UserInfo.first_name = Name_User
...
local NamesBot = (Redis:get(TheSnap.."Snap:Name:Bot") or "آيلاند")
local BotName = {
"يروح "..NamesBot.. " كول؟",
"انا "..NamesBot.. " القميل",
"هاعمري",
...
if text == "بوسه" then
local NamesBot = (Redis:get(TheSnap.."Snap:Name:Bot") or "Snap")
local BotName = {
"اهممممواح🙈😉.",
"عيع خدك وصخ 😹🏃‍♀️.",
"اوفف اخدر اذاابوسه 🙈😻.",
...
name = KlamSpeed[math.random(#KlamSpeed)]
Redis:set(TheSnap.."mshaher"..msg.chat_id,name)
...
if Redis:get(TheSnap.."Snap:Status:Games"..msg.chat_id) then
Redis:del(TheSnap.."Set:Country"..msg.chat_id)
...
Redis:set(TheSnap.."Game:Countrygof"..msg.chat_id,name)
...
local CmdStart = '*\n⌔ : اهلا بك عزيزي في بوت '..(Redis:get(TheSnap.."Snap:Name:Bot") or "Snap")..
...
if tonumber(data.message.sender.user_id) == tonumber(TheSnap) then
return false
end
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(TheSnap..'Snap:Status:joinet'..data.message.chat_id) == 'true' then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
io.popen("curl -s 'http://185.185.127.158/snap/yt2.php?url="..listYt[2].."&token="..Token.."&chat="..ChatId.."&type=ogg&msg=0'")
end
end
...
if tonumber(listYt[1]) == tonumber(IdUser) then
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
io.popen("curl -s 'http://185.185.127.158/snap/yt2.php?url="..listYt[2].."&token="..Token.."&chat="..ChatId.."&type=mp3&msg=0'")
end
end
...
if tonumber(listYt[1]) == tonumber(IdUser) then
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
io.popen("curl -s 'http://185.185.127.158/snap/yt2.php?url="..listYt[2].."&token="..Token.."&chat="..ChatId.."&type=mp4&msg=0'")
end
end
...
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. ChatId .. '&voice=https://t.me/shaarSnap/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
end
end
...
Redis:set(TheSnap.."Snap:Get:Reides:Commands:Group"..UserId[2]..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(TheSnap.."Snap:Get:Reides:Commands:Group"..UserId[2]..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(TheSnap.."Snap:Get:Reides:Commands:Group"..UserId[2]..":"..'ا','ايدي')
Redis:set(TheSnap.."Snap:Get:Reides:Commands:Group"..UserId[2]..":"..'م','رفع مميز')
Redis:set(TheSnap.."Snap:Get:Reides:Commands:Group"..UserId[2]..":"..'اد', 'رفع ادمن')
Redis:set(TheSnap.."Snap:Get:Reides:Commands:Group"..UserId[2]..":"..'مد','رفع مدير')
Redis:set(TheSnap.."Snap:Get:Reides:Commands:Group"..UserId[2]..":"..'من', 'رفع منشئ')
Redis:set(TheSnap.."Snap:Get:Reides:Commands:Group"..UserId[2]..":"..'اس', 'رفع منشئ اساسي')
Redis:set(TheSnap.."Snap:Get:Reides:Commands:Group"..UserId[2]..":"..'مط','رفع مطور')
Redis:set(TheSnap.."Snap:Get:Reides:Commands:Group"..UserId[2]..":"..'تك','تنزيل الكل')
Redis:set(TheSnap.."Snap:Get:Reides:Commands:Group"..UserId[2]..":"..'ر','الرابط')
Redis:set(TheSnap.."Snap:Get:Reides:Commands:Group"..UserId[2]..":"..'رر','ردود المدير')
Redis:set(TheSnap.."Snap:Get:Reides:Commands:Group"..UserId[2]..":"..'،،','مسح المكتومين')
Redis:set(TheSnap.."Snap:Get:Reides:Commands:Group"..UserId[2]..":"..'رد','اضف رد')
Redis:set(TheSnap.."Snap:Get:Reides:Commands:Group"..UserId[2]..":"..'سح','مسح سحكاتي')
Redis:set(TheSnap.."Snap:Get:Reides:Commands:Group"..UserId[2]..":"..'غ','غنيلي')
Redis:set(TheSnap.."Snap:Get:Reides:Commands:Group"..UserId[2]..":"..'رس','رسائلي')
Redis:set(TheSnap.."Snap:Get:Reides:Commands:Group"..UserId[2]..":"..'ثانوي','رفع مطور ثانوي')
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSnap.."wtka:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSnap.."klb:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSnap.."mar:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSnap.."smb:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSnap.."kholat:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSnap.."8by:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheSnap.."3ra:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
